...
''' </summary>
Public NotInheritable Class VistaMessageBox
...
#Region " MessageBox "
	...
	Public Shared Function Show(ByVal owner As IWin32Window, ByVal text As String, ByVal caption As String, ByVal buttons As MessageBoxButtons, ByVal icon As MessageBoxIcon, ByVal defaultButton As MessageBoxDefaultButton) As DialogResult
		Dim vd As New VistaMessageBox()
		vd.Content = text
		vd.WindowTitle = caption
		Select Case buttons
			Case MessageBoxButtons.AbortRetryIgnore
				vd.Buttons = New VistaMessageBoxButton() {New VistaMessageBoxButton(VistaMessageBoxResult.Abort), New VistaMessageBoxButton(VistaMessageBoxResult.Retry), New VistaMessageBoxButton(VistaMessageBoxResult.Ignore)}
			Case MessageBoxButtons.OKCancel
				vd.Buttons = New VistaMessageBoxButton() {New VistaMessageBoxButton(VistaMessageBoxResult.OK), New VistaMessageBoxButton(VistaMessageBoxResult.Cancel)}
			Case MessageBoxButtons.RetryCancel
				vd.Buttons = New VistaMessageBoxButton() {New VistaMessageBoxButton(VistaMessageBoxResult.Retry), New VistaMessageBoxButton(VistaMessageBoxResult.Cancel)}
			Case MessageBoxButtons.YesNo
				vd.Buttons = New VistaMessageBoxButton() {New VistaMessageBoxButton(VistaMessageBoxResult.Yes), New VistaMessageBoxButton(VistaMessageBoxResult.No)}
			Case MessageBoxButtons.YesNoCancel
				vd.Buttons = New VistaMessageBoxButton() {New VistaMessageBoxButton(VistaMessageBoxResult.Yes), New VistaMessageBoxButton(VistaMessageBoxResult.No), New VistaMessageBoxButton(VistaMessageBoxResult.Cancel)}
			Case Else
				vd.Buttons = New VistaMessageBoxButton() {New VistaMessageBoxButton(VistaMessageBoxResult.OK)}
		End Select
		Select Case icon
			Case MessageBoxIcon.Asterisk, MessageBoxIcon.Information
				vd.MainIcon = VistaMessageBoxIcon.Information
			Case MessageBoxIcon.Exclamation, MessageBoxIcon.Warning
				vd.MainIcon = VistaMessageBoxIcon.Warning
			Case MessageBoxIcon.Error, MessageBoxIcon.Hand, MessageBoxIcon.Stop
				vd.MainIcon = VistaMessageBoxIcon.Error
			Case MessageBoxIcon.Question
				vd.MainIcon = VistaMessageBoxIcon.Question
			Case Else
				vd.CustomMainIcon = Nothing
		End Select
		vd.DefaultButton = MakeVistaMessageBoxDefaultButton(defaultButton)
		vd.Owner = owner
		vd.Show()
...
#Region " Methods "
	...
	''' <summary>
	''' Shows the VistaMessageBox form as a modal dialog box.
	''' </summary>
	''' <returns>One of the VistaMessageBoxResult values.</returns>
	Public Function Show() As VistaMessageBoxResult
		If LockSystem Then
	...
	Private Function ShowInternal(ByVal Owner As IWin32Window) As VistaMessageBoxResult
		Using vdf As VistaMessageBoxForm = New VistaMessageBoxForm()
			_vdf = vdf
			...
			Result = DirectCast(vdf.Tag, VistaMessageBoxButton).VistaMessageBoxResult
			Return Result
		End Using
	End Function
	...
	Private _vdf As VistaMessageBoxForm

	''' <summary>
	''' Closes the VistaMessageBox form.
	''' </summary>
	''' <param name="result">A VistaMessageBoxResult that represents the result of the form.</param>
	Public Sub Close(ByVal result As VistaMessageBoxResult)
		...
		End If
		Dim vButton As VistaMessageBoxButton = New VistaMessageBoxButton(result)
		_vdf.Tag = vButton
...
#Region " Fields and Properties "
	...
	Public Property Sound() As ISound
		Get
			If _lockSystem AndAlso _sound Is Nothing Then
				Return VistaMessageBoxSound.Security
			End If
			Return _sound
		End Get
	...
	''' <summary>
	''' Gets or sets the array of the VistaMessageBoxButtons that specifies which buttons to display in the Vista-like task dialog.
	''' </summary>
	Public Property Buttons() As VistaMessageBoxButton()
		Get
			Return _vButtons
		End Get
	...
	''' <summary>
	''' Gets or sets the one of the VistaMessageBoxIcon values that specifies which icon on what background to display in the Vista-like task dialog.
	''' </summary>
	...
	''' <summary>
	''' Gets or sets the one of the VistaMessageBoxIcon values that specifies which icon to display in the footer of the Vista-like task dialog.
	''' </summary>
	...
	Private _defaultButton As VistaMessageBoxDefaultButton = VistaMessageBoxDefaultButton.Button1
	''' <summary>
	''' Gets or sets one of the VistaMessageBoxDefaultButton values that specifies the default button for the Vista-like task dialog.
	''' </summary>
	...
	Private _result As VistaMessageBoxResult
	''' <summary>
	''' Gets or sets the dialog result for the VistaMessageBox form.
	''' </summary>
	Public Property Result() As VistaMessageBoxResult
		Get
			Return _result
		End Get
...
#Region " System Locking Methods "
	...
	Private Function LockSystemAndShow() As VistaMessageBoxResult
		...
		Using g As Graphics = Graphics.FromImage(background)
			...
			newDesktop = CreateDesktop("Bureau" & Guid.NewGuid().ToString(), Nothing, Nothing, 0, GENERIC_ALL, Nothing)
			...
			newThread.Start(New VistaMessageBoxLockSystemParameters(newDesktop, background))
			newThread.Join()
	...
	Private Sub NewThreadMethod(ByVal params As Object)
		Dim v As VistaMessageBoxLockSystemParameters = DirectCast(params, VistaMessageBoxLockSystemParameters)
