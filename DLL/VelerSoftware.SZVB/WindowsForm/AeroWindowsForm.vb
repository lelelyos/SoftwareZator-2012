...
#Region "OKButtonText"
    ...
    Private _OKButtonText As String = ""
...
#End Region
    ...
    Private Sub ActionForm_Shown(sender As System.Object, e As System.EventArgs) Handles MyBase.Shown
        If Me.Height > System.Windows.Forms.Screen.PrimaryScreen.WorkingArea.Height AndAlso Me.Header_Panel.Visible Then
            ...
            Me.UseAero = False
            If (VelerSoftware.SZVB.Windows.Core.RunningOnWinVistaOr7Or8) Then
                Dim af As VelerSoftware.SZVB.Windows.DWM.Margins = New VelerSoftware.SZVB.Windows.DWM.Margins(Me.Header_Panel.Location.X, 0, 0, 0)
                VelerSoftware.SZVB.Windows.DWM.DwmExtendFrameIntoClientArea(Me.Handle, af)
            End If
        End If
    End Sub
