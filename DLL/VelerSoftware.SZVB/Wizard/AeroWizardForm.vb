...
#Region "NextButtonText"
    ...
    Private _NextButtonText As String = ""
    <ComponentModel.Category("Propriétés de AeroWizardForm"), ComponentModel.Description("Texte du bouton 'Suivant'"), ComponentModel.DefaultValue("")> _
...
#Region "FinishButtonText"
    ...
    Private _FinishButtonText As String = ""
    <ComponentModel.Category("Propriétés de AeroWizardForm"), ComponentModel.Description("Texte du bouton 'Terminer'"), ComponentModel.DefaultValue("")> _
...
#Region "CancelButtonText"
    ...
    Private _CancelButtonText As String = ""
    <ComponentModel.Category("Propriétés de AeroWizardForm"), ComponentModel.Description("Texte du bouton 'Annuler'"), ComponentModel.DefaultValue("")> _
...
#Region "BackCaption"
    ...
    Private _BackCaption As String = ""
    <ComponentModel.Category("Propriétés de AeroWizardForm"), ComponentModel.Description("Texte affiché lors du passage de la souris sur le bouton Précédent."), ComponentModel.DefaultValue("")> _
...
#Region "WizardIcon"
    ...
    Private _WizardIcon As Drawing.Image = Nothing
...
#Region "Method Events"
    ...
    Private Sub BackCaption_Changed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.OnBackCaptionChanged
        Me.ToolTip2.SetToolTip(Me.Back_PictureBox, BackCaption)
    End Sub
...
#End Region
    ...
    Private Sub WizardForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Me.DesignMode Then
            If (VelerSoftware.SZVB.Windows.Core.RunningOnWinVistaOr7Or8) Then
                If VelerSoftware.SZVB.Windows.DWM.DwmIsCompositionEnabled() Then
                    If UseAero Then
                        ' Activer le style Aero Glass (RibbonProfesionalRendererColorTableBlueGlass)
                        Me.BackColor = Drawing.Color.Black
                        Dim af As VelerSoftware.SZVB.Windows.DWM.Margins = New VelerSoftware.SZVB.Windows.DWM.Margins(Me.Header_Panel.Location.X, 0, Me.Header_Panel.Location.Y + Me.Header_Panel.Height, 0)
                        VelerSoftware.SZVB.Windows.DWM.DwmExtendFrameIntoClientArea(Me.Handle, af)
                        AeroEnabled = True
                    Else
    ...
    Private Sub WizardForm_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseMove, Header_Panel.MouseMove, Icon_PictureBox.MouseMove, Title_Label.MouseMove
    ...
    Private Sub WizardForm_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseDown, Header_Panel.MouseDown, Icon_PictureBox.MouseDown, Title_Label.MouseDown
    ...
    Private Sub WizardForm_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp, Header_Panel.MouseUp, Icon_PictureBox.MouseUp, Title_Label.MouseUp
        If e.Button = System.Windows.Forms.MouseButtons.Left Then
    ...
    Public Sub DisableBackButton()
        If VelerSoftware.SZVB.Windows.Core.RunningOnWin8 Then
        ...
        If (VelerSoftware.SZVB.Windows.Core.RunningOnWinVistaOr7Or8) Then
            ...
            Else
                If Me.Title_Label.Text.Length > 0 Then
                    ...
                    VelerSoftware.SZVB.Windows.DWM.DrawTextGlow(e.Graphics, Me.Title_Label.Text, Me.Title_Label.Font, Me.Title_Label.Bounds, Me.Title_Label.ForeColor, System.Windows.Forms.TextFormatFlags.VerticalCenter Or System.Windows.Forms.TextFormatFlags.HorizontalCenter Or System.Windows.Forms.TextFormatFlags.NoPrefix Or System.Windows.Forms.TextFormatFlags.SingleLine)
                End If
            End If
        End If
    End Sub
