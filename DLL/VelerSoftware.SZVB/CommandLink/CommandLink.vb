...
Public Class CommandLink
	...
	Public Sub New()
		...
		ForeColor = Color.FromArgb(0, 102, 204)	' 0 51 153
		'Font * 4 / 3
...
#Region " Fields and Properties "
	...
	Public ReadOnly Property State() As PushButtonState
		Get
            If Not Enabled Then Return PushButtonState.Disabled
            If isPressed Then Return PushButtonState.Pressed
            If isHovered Then Return PushButtonState.Hot
            If isFocused OrElse IsDefault Then Return PushButtonState.[Default]
...
#Region " Animation Support "
	...
	Private Sub FadeTo(ByVal frameType As FrameType, ByVal animationDuration As Integer)
		...
		If animatingFrom = frameType Then
			If Me.animationDuration = 0 Then
				animationProgress = 0
			Else
