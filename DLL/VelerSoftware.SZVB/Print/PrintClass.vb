...
Namespace Print
    ...
    Public Class PrintClass
        ...
        Public my_isWinXPStyle As Boolean = False
        ...
        Public Function Print(ByVal isShowPrevisualisation As Boolean, ByVal isShowPrinterOption As Boolean) As Boolean
            ...
            If isOkToContinue Then
                If isShowPrevisualisation Then
                    ...
                    If myPreview.ShowDialog() = System.Windows.Forms.DialogResult.Cancel Then
                        isOkToContinue = False
                    End If
                End If
            End If
        ...
        Private Sub PrintPage(ByVal sender As Object, ByVal ev As System.Drawing.Printing.PrintPageEventArgs)
            ev.Graphics.SmoothingMode = Drawing.Drawing2D.SmoothingMode.AntiAlias
            ev.Graphics.CompositingQuality = Drawing.Drawing2D.CompositingQuality.HighQuality
                ...
                If theCurrentObj.my_PageNum = theCurrentPage Then
                    ...
                    Select Case theCurrentObj.my_Type
                        ...
                        Case ObjectType.Picturebox
                            ...
                            Else
                                ev.Graphics.DrawImage(thePicture.Image, theCurrentObj.my_RectBorder.X, theCurrentObj.my_RectBorder.Y, thePicture.Width, thePicture.Height)
                            End If
        ...
        Public Sub AddText(ByVal theUpperCorner As System.Drawing.Point, ByVal theString As String, ByVal theTextColor As System.Drawing.Color, ByVal theTextFont As System.Drawing.Font, ByVal thePageNum As Int32)
            Dim theRect As New System.Drawing.Rectangle(theUpperCorner.X, theUpperCorner.Y, CType((theString.Length * my_DefaultFont.Size), Integer), my_DefaultFont.Height)
            ...
            AddShape(ShapeType.Rectangle, theRect, Nothing, System.Drawing.Color.White, 0, thePageNum, _
              False, System.Drawing.Color.White, System.Drawing.Color.White, my_DefaultGradientAngle, theString, System.Drawing.StringAlignment.Near, _
              theTextColor, 0, System.Math.Max(System.Threading.Interlocked.Increment(my_ZOrder), my_ZOrder - 1))
        ...
        Public Sub SetDocument(ByVal c As System.Windows.Forms.Control, ByVal X As Integer, ByVal Y As Integer, ByVal NumPage As Integer)
            ...
            AddImage(buffer, X, Y, buffer.Width, buffer.Height, NumPage)
    ...
    Public Class PrintRichTextBox
        ...
        Private RichTextCtrl As System.Windows.Forms.RichTextBox
        ...
        Public Sub New(ByVal rich As System.Windows.Forms.RichTextBox)
            RichTextCtrl = rich
