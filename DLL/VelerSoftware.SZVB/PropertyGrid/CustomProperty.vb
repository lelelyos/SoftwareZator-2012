...
#Region "Protected variables"
        ...
        ' Public Events
        Public Event OnBubbleEvent(ByVal sender As Integer, ByVal e As Object)
...
#Region "Private methods"
        ...
        Private Property DataColumn() As Object
            Get
                Dim oRow As Data.DataRow = CType(oRef, System.Data.DataRow)
                If oRow.RowState <> Data.DataRowState.Deleted Then
                    If oDatasource Is Nothing Then
                        Return oRow(sProp)
                    Else
                        Dim oLookupTable As Data.DataTable = TryCast(oDatasource, Data.DataTable)
        ...
        Private Sub OnCollectionChange(ByVal sender As Integer, ByVal e As Object)
            RaiseEvent OnBubbleEvent(sender, e)
        End Sub
...
#Region "Public properties"
        ...
        <Category("Appearance"), _
         DisplayName("Name"), _
         System.ComponentModel.Description("Display Name of the CustomProperty."), _
        ...
        <Category("Appearance"), _
         ...
         System.ComponentModel.Description("Set read only attribute of the CustomProperty."), _
        ...
        <Category("Appearance"), _
         System.ComponentModel.Description("Set visibility attribute of the CustomProperty.")> _
        ...
        <Category("Appearance"), _
         System.ComponentModel.Description("Represent the Value of the CustomProperty.")> _
        Public Property Value() As Object
            Get
                If bRef Then
                    If TryCast(oRef, Data.DataRow) IsNot Nothing Then
        ...
        <Category("Appearance"), _
         System.ComponentModel.Description("Set description associated with the CustomProperty.")> _
        ...
        <Category("Appearance"), Browsable(False), _
         System.ComponentModel.Description("Set category associated with the CustomProperty.")> _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Indicates if the property is browsable or not."), _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Specify the label shown when the property is browsable"), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
        ...
        <Category("Appearance"), _
         ...
         System.ComponentModel.Description("Indicates whether the name of the associated property is displayed with parentheses in the Properties window."), _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Indicates the style of the label when a property is browsable."), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Indicates if the property is masked or not."), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Indicates if the property represents a value in percentage."), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Indicates if the property uses a FileNameEditor converter."), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Apply a filter to FileNameEditor converter."), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("DialogType of the FileNameEditor."), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
        ...
        <Category("Behavior"), _
         System.ComponentModel.Description("Custom Choices list."), _
         XmlElementAttribute(IsNullable:=False), Browsable(False)> _
