...
Namespace PropertyGrids
	...
	<Designer(GetType(System.Windows.Forms.Design.ControlDesigner)), _
	 ToolboxBitmap(GetType(PropertyGrids))> _
	Public Class PropertyGrids
...
#Region "Public Functions"
		Public Sub New()
			...
			' FAIT EN SORTE D'AFFICHER UN AUTRE EDITEUR POUR LES PROPRIETES DE TYPE SYSTEM.DRAWING.IMAGE
            TypeDescriptor.AddAttributes(GetType(System.Drawing.Image), New EditorAttribute(GetType(UIImageEditor), GetType(Drawing.Design.UITypeEditor)))
		...
		Protected Sub AutoSizeSplitter(Optional ByVal RightMargin As Integer = 24)
			...
			For Each oItem In oItemCollection
				...
				If oItem.GridItemType = GridItemType.Property Then
					CurWidth = oGraphics.MeasureString(oItem.Label, Me.Font).Width + RightMargin + (nested - 1)
...
#Region "Properties"
		...
		<Category("Behavior"), _
		 ...
		 System.ComponentModel.Description("Set the collection of the CustomProperty. Set ShowCustomProperties to True to enable it."), _
		...
		<Category("Behavior"), _
		 DesignerSerializationVisibility(DesignerSerializationVisibility.Content), _
		 System.ComponentModel.Description("Set the CustomPropertyCollectionSet. Set ShowCustomPropertiesSet to True to enable it."), _
		 RefreshProperties(RefreshProperties.Repaint)> _
		...
		<Category("Behavior"), _
		 ...
		 System.ComponentModel.Description("Move automatically the splitter to better fit all the properties shown.")> _
		...
		<Category("Behavior"), _
		 DefaultValue(False), _
		 System.ComponentModel.Description("Use the custom properties collection as SelectedObject."), _
		...
		<Category("Behavior"), _
		 DefaultValue(False), _
		 System.ComponentModel.Description("Use the custom properties collections as SelectedObjects."), _
		 RefreshProperties(RefreshProperties.All)> _
		...
		<Category("Appearance"), _
		 DefaultValue(False), _
		 System.ComponentModel.Description("Draw a flat toolbar")> _
		...
		<Category("Appearance"), _
		 ...
		 DesignerSerializationVisibility(DesignerSerializationVisibility.Content), _
		 System.ComponentModel.Description("Toolbar object"), _
		 Browsable(True)> _
		...
		<Category("Appearance"), _
		 DisplayName("Help"), _
		 System.ComponentModel.Description("DocComment object. Represent the comments area of the PropertyGrid."), _
		...
		<Category("Appearance"), _
		 ...
		 DesignerSerializationVisibility(DesignerSerializationVisibility.Content), _
		 System.ComponentModel.Description("Help Title Label."), _
		 Browsable(True)> _
		...
		<Category("Appearance"), _
		 ...
		 DesignerSerializationVisibility(DesignerSerializationVisibility.Content), _
		 System.ComponentModel.Description("Help Description Label."), _
		 Browsable(True)> _
		...
		<Category("Appearance"), _
		 ...
		 System.ComponentModel.Description("Help Image Background.")> _
...
#End Region
		...
		Public Shadows Sub ExpandAllGridItems()
			MyBase.ExpandAllGridItems()
			If bAutoSizeProperties Then AutoSizeSplitter()
		End Sub
