    ...
    public class VisualTaskDialog : KryptonForm
    {
        ...
        private Size UpdateMainTextSizing()
        {
            ...
            using (Graphics g = CreateGraphics())
            {
                ...
                messageContentSize.Width = (int)((float)messageMainSize.Width * factorX);
                messageContentSize.Height = (int)((float)messageMainSize.Height * factorY);
        ...
        {
            this._panelMain = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._panelMainSpacer = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._panelMainCommands = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._panelMainRadio = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._panelMainText = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._messageContent = new VelerSoftware.Design.Toolkit.KryptonWrapLabel();
            this._messageText = new VelerSoftware.Design.Toolkit.KryptonWrapLabel();
            this._panelIcon = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._messageIcon = new System.Windows.Forms.PictureBox();
            this._panelButtons = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._checkBox = new VelerSoftware.Design.Toolkit.KryptonCheckBox();
            this._panelButtonsBorderTop = new VelerSoftware.Design.Toolkit.KryptonBorderEdge();
            this._buttonOK = new VelerSoftware.Design.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonYes = new VelerSoftware.Design.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonNo = new VelerSoftware.Design.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonRetry = new VelerSoftware.Design.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonCancel = new VelerSoftware.Design.Toolkit.VisualTaskDialog.MessageButton();
            this._buttonClose = new VelerSoftware.Design.Toolkit.VisualTaskDialog.MessageButton();
            this._panelFooter = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._linkLabelFooter = new VelerSoftware.Design.Toolkit.KryptonLinkLabel();
            this._iconFooter = new System.Windows.Forms.PictureBox();
            this._footerLabel = new VelerSoftware.Design.Toolkit.KryptonWrapLabel();
            this._panelFooterBorderTop = new VelerSoftware.Design.Toolkit.KryptonBorderEdge();
            ...
            this._messageContent.LabelStyle = VelerSoftware.Design.Toolkit.LabelStyle.NormalPanel;
            ...
            this._messageText.LabelStyle = VelerSoftware.Design.Toolkit.LabelStyle.TitlePanel;
            ...
            this._panelButtons.PanelBackStyle = VelerSoftware.Design.Toolkit.PaletteBackStyle.PanelAlternate;
            this._panelButtons.Size = new System.Drawing.Size(408, 46);
            this._panelButtons.TabIndex = 1;
            // 
            // _checkBox
            // 
            this._checkBox.LabelStyle = VelerSoftware.Design.Toolkit.LabelStyle.NormalPanel;
            ...
            // 
            this._panelButtonsBorderTop.BorderStyle = VelerSoftware.Design.Toolkit.PaletteBorderStyle.HeaderPrimary;
            ...
            this._panelFooter.PanelBackStyle = VelerSoftware.Design.Toolkit.PaletteBackStyle.PanelAlternate;
            this._panelFooter.Size = new System.Drawing.Size(408, 49);
            this._panelFooter.TabIndex = 2;
            // 
            // _linkLabelFooter
            // 
            this._linkLabelFooter.LabelStyle = VelerSoftware.Design.Toolkit.LabelStyle.NormalPanel;
            ...
            this._footerLabel.LabelStyle = VelerSoftware.Design.Toolkit.LabelStyle.NormalPanel;
            ...
            // 
            this._panelFooterBorderTop.BorderStyle = VelerSoftware.Design.Toolkit.PaletteBorderStyle.HeaderPrimary;
