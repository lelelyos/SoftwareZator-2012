...
namespace VelerSoftware.Design.Toolkit
{
    ...
    [Designer("VelerSoftware.Design.Toolkit.KryptonBreadCrumbItemDesigner, VelerSoftware.Design.Design, Version=1.0.0.0, Culture=neutral, PublicKeyToken=0a7b25493f100a50")]
    public class KryptonBreadCrumbItem : KryptonListItem
    {
        ...
        /// </summary>
        [Editor("VelerSoftware.Design.Toolkit.KryptonBreadCrumbItemsEditor, VelerSoftware.Design.Design, Version=1.0.0.0, Culture=neutral, PublicKeyToken=0a7b25493f100a50", typeof(UITypeEditor))]
