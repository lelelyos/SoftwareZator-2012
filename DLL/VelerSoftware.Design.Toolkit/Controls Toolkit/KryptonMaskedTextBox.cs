...
namespace VelerSoftware.Design.Toolkit
{
    ...
    [Designer("VelerSoftware.Design.Toolkit.KryptonMaskedTextBoxDesigner, VelerSoftware.Design.Design, Version=1.0.0.0, Culture=neutral, PublicKeyToken=0a7b25493f100a50")]
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(ForeColor))
                                            g.DrawString(MaskedTextProvider.ToDisplayString(), Font, foreBrush,
                                    ...
                                    {
                                        using (SolidBrush foreBrush = new SolidBrush(ForeColor))
                                            g.DrawString(MaskedTextProvider.ToDisplayString(), _kryptonMaskedTextBox.GetTripleState().PaletteContent.GetContentShortTextFont(PaletteState.Disabled), foreBrush,
                                                         new RectangleF(rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top),
                                                         stringFormat);
                                    }
                                }
