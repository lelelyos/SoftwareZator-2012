...
namespace VelerSoftware.Design.Toolkit
{
    ...
    public class KryptonMessageBox : KryptonForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._panelMessageText = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._messageText = new VelerSoftware.Design.Toolkit.KryptonWrapLabel();
            this._panelMessageIcon = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this._messageIcon = new System.Windows.Forms.PictureBox();
            this._panelButtons = new VelerSoftware.Design.Toolkit.KryptonPanel();
            this.borderEdge = new VelerSoftware.Design.Toolkit.KryptonBorderEdge();
            this._button3 = new VelerSoftware.Design.Toolkit.KryptonMessageBox.MessageButton();
            this._button1 = new VelerSoftware.Design.Toolkit.KryptonMessageBox.MessageButton();
            this._button2 = new VelerSoftware.Design.Toolkit.KryptonMessageBox.MessageButton();
            ...
            this._messageText.LabelStyle = VelerSoftware.Design.Toolkit.LabelStyle.NormalPanel;
            ...
            // borderEdge
            // 
            this.borderEdge.BorderStyle = VelerSoftware.Design.Toolkit.PaletteBorderStyle.HeaderPrimary;
