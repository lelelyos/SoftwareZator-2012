...
namespace VelerSoftware.Design.Toolkit
{
    ...
    [Designer("VelerSoftware.Design.Toolkit.KryptonLinkLabelDesigner, VelerSoftware.Design.Design, Version=1.0.0.0, Culture=neutral, PublicKeyToken=0a7b25493f100a50")]
