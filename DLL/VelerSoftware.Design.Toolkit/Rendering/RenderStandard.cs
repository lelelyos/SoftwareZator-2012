...
namespace VelerSoftware.Design.Toolkit
{
	...
	public class RenderStandard : RenderBase
    {
		...
		/// <param name="useMnemonic">Should mnemonics be processed.</param>
		/// <param name="state">State associated with rendering.</param>
                                                     ...
                                                     bool composition)
		{
            ...
            using (StandardContentMemento memento = new StandardContentMemento(useMnemonic))
            {
                                                  ...
                                                  bool composition)
		{
			...
			StandardContentMemento memento = new StandardContentMemento(useMnemonic);
                                                 ...
                                                 int maximum)
        {
            ...
            using (Pen tickPen = new Pen(elementPalette.GetElementColor1(state)))
            {
                if (orientation == Orientation.Horizontal)
                {
                    ...
                    for (int i = minimum, y=0; i <= maximum; i++, y++)
                    {
        ...
        private class StandardContentMemento : IDisposable
		{
			...
			public StandardContentMemento(bool useMnemonic)
			{
                // Remember incoming parameter
