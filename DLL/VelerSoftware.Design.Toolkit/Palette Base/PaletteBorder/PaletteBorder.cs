...
namespace VelerSoftware.Design.Toolkit
{
								 ...
								 IPaletteBorder
    {
        ...
        [RefreshPropertiesAttribute(RefreshProperties.All)]
        [Editor("VelerSoftware.Design.Toolkit.PaletteDrawBordersEditor, VelerSoftware.Design.Design, Version=1.0.0.0, Culture=neutral, PublicKeyToken=0a7b25493f100a50", typeof(UITypeEditor))]
