...
namespace VelerSoftware.Design.Toolkit
{
                                    ...
                                    IContentValues
    {
        ...
        private Size MaxGridCellDay(ViewLayoutContext context)
        {
            ...
            Size normalSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateNormal.Day.Content, this, VisualOrientation.Top, false, PaletteState.Normal, false);
            Size disabledSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateDisabled.Day.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);
            Size trackingSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateTracking.Day.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);
            Size pressedSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StatePressed.Day.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);
            Size checkedNormalSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateCheckedNormal.Day.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);
            Size checkedTrackingSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateCheckedTracking.Day.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);
            Size checkedPressedSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateCheckedPressed.Day.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);
        ...
        private Size MaxGridCellDayOfWeek(ViewLayoutContext context)
        {
            ...
            // Find sizes required for the different 
            Size shortNormalSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateNormal.DayOfWeek.Content, this, VisualOrientation.Top, false, PaletteState.Normal, false);
            Size shortDisabledSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateDisabled.DayOfWeek.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);

            _shortText = "A" + _dayOfWeekMeasure;

            // Find sizes required for the different 
            Size fullNormalSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateNormal.DayOfWeek.Content, this, VisualOrientation.Top, false, PaletteState.Normal, false);
            Size fullDisabledSize = context.Renderer.RenderStandardContent.GetContentPreferredSize(context, _calendar.StateDisabled.DayOfWeek.Content, this, VisualOrientation.Top, false, PaletteState.Disabled, false);
