...
namespace VelerSoftware.Design.Navigator
{
                                                     ...
                                                     ISeparatorSource
	{
        ...
        static ViewBuilderOutlookBase()
        {
            ...
            Stream streamBlueUp = myAssembly.GetManifestResourceStream("VelerSoftware.Design.Navigator.Resources.BlueUp.bmp");
            Stream streamBlueDown= myAssembly.GetManifestResourceStream("VelerSoftware.Design.Navigator.Resources.BlueDown.bmp");
