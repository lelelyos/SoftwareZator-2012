        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonCheckBox != null) && (_ribbonCheckBox.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move CheckBox First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move CheckBox Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move CheckBox Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move CheckBox Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteCheckBoxMenu = new ToolStripMenuItem("Delete CheckBox", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteCheckBox));
