        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonCluster != null) && (_ribbonCluster.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Cluster First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Cluster Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Cluster Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Cluster Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _addButtonMenu = new ToolStripMenuItem("Add Button", VelerSoftware.Design.Design.Properties.Resources.KryptonRibbonGroupClusterButton, new EventHandler(OnAddButton));
                    _addColorButtonMenu = new ToolStripMenuItem("Add Color Button", VelerSoftware.Design.Design.Properties.Resources.KryptonRibbonGroupClusterColorButton, new EventHandler(OnAddColorButton));
                    _clearItemsMenu = new ToolStripMenuItem("Clear Items", null, new EventHandler(OnClearItems));
                    _deleteClusterMenu = new ToolStripMenuItem("Delete Cluster", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteCluster));
