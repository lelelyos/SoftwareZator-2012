        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
                 ...
                 _ribbonTriple.RibbonGroup.Items.Contains(_ribbonTriple))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Triple First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Triple Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Triple Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Triple Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    ...
                    _deleteTripleMenu = new ToolStripMenuItem("Delete Triple", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteTriple));                    
