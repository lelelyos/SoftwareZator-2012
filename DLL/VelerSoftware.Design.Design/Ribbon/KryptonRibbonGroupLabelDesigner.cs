        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonLabel != null) && (_ribbonLabel.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Label First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Label Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Label Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Label Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteLabelMenu = new ToolStripMenuItem("Delete Label", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteLabel));
