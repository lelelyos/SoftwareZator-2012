        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonRichTextBox != null) && (_ribbonRichTextBox.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move RichTextBox First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move RichTextBox Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move RichTextBox Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move RichTextBox Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteRichTextBoxMenu = new ToolStripMenuItem("Delete RichTextBox", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteTextBox));
