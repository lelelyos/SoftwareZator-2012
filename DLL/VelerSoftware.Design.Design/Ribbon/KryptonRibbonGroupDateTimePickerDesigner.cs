        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonDateTimePicker != null) && (_ribbonDateTimePicker.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move DateTimePicker First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move DateTimePicker Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move DateTimePicker Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move DateTimePicker Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteDateTimePickerMenu = new ToolStripMenuItem("Delete DateTimePicker", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteDateTimePicker));
