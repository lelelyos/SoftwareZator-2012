        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonRadioButton != null) && (_ribbonRadioButton.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move RadioButton First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move RadioButton Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move RadioButton Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move RadioButton Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteRadioButtonMenu = new ToolStripMenuItem("Delete RadioButton", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteRadioButton));
