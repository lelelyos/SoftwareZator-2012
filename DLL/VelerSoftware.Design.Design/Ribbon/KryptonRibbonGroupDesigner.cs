        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
                 ...
                 _ribbonGroup.RibbonTab.Groups.Contains(_ribbonGroup))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Group First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Group Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Group Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Group Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _moveToTabMenu = new ToolStripMenuItem("Move Group To Tab");
                    _addTripleMenu = new ToolStripMenuItem("Add Triple", VelerSoftware.Design.Design.Properties.Resources.KryptonRibbonGroupTriple, new EventHandler(OnAddTriple));
                    _addLinesMenu = new ToolStripMenuItem("Add Lines", VelerSoftware.Design.Design.Properties.Resources.KryptonRibbonGroupLines, new EventHandler(OnAddLines));
                    _addSeparatorMenu = new ToolStripMenuItem("Add Separator", VelerSoftware.Design.Design.Properties.Resources.KryptonRibbonGroupSeparator, new EventHandler(OnAddSep));
                    _addGalleryMenu = new ToolStripMenuItem("Add Gallery", VelerSoftware.Design.Design.Properties.Resources.KryptonGallery, new EventHandler(OnAddGallery));
                    _clearItemsMenu = new ToolStripMenuItem("Clear Items", null, new EventHandler(OnClearItems));
                    _deleteGroupMenu = new ToolStripMenuItem("Delete Group", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteGroup));
