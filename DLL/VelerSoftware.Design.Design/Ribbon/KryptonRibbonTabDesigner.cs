        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
                 ...
                 _ribbonTab.Ribbon.RibbonTabs.Contains(_ribbonTab))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _addGroupMenu = new ToolStripMenuItem("Add Group", VelerSoftware.Design.Design.Properties.Resources.KryptonRibbonGroup, new EventHandler(OnAddGroup));
                    _clearGroupsMenu = new ToolStripMenuItem("Clear Groups", null, new EventHandler(OnClearGroups));
                    _deleteTabMenu = new ToolStripMenuItem("Delete Tab", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteTab));
