        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonCustomControl != null) && (_ribbonCustomControl.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move Custom Control First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move Custom Control Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move Custom Control Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move Custom Control Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteCustomControlMenu = new ToolStripMenuItem("Delete Custom Control", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteCustomControl));
