        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonTrackBar != null) && (_ribbonTrackBar.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move TrackBar First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move TrackBar Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move TrackBar Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move TrackBar Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteTrackBarMenu = new ToolStripMenuItem("Delete TrackBar", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteTrackBar));
