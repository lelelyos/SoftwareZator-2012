        ...
        private void OnContextMenu(object sender, MouseEventArgs e)
        {
            if ((_ribbonMaskedTextBox != null) && (_ribbonMaskedTextBox.Ribbon != null))
            {
                ...
                if (_cms == null)
                {
                    ...
                    _moveFirstMenu = new ToolStripMenuItem("Move TextBox First", VelerSoftware.Design.Design.Properties.Resources.MoveFirst, new EventHandler(OnMoveFirst));
                    _movePreviousMenu = new ToolStripMenuItem("Move TextBox Previous", VelerSoftware.Design.Design.Properties.Resources.MovePrevious, new EventHandler(OnMovePrevious));
                    _moveNextMenu = new ToolStripMenuItem("Move TextBox Next", VelerSoftware.Design.Design.Properties.Resources.MoveNext, new EventHandler(OnMoveNext));
                    _moveLastMenu = new ToolStripMenuItem("Move TextBox Last", VelerSoftware.Design.Design.Properties.Resources.MoveLast, new EventHandler(OnMoveLast));
                    _deleteTextBoxMenu = new ToolStripMenuItem("Delete TextBox", VelerSoftware.Design.Design.Properties.Resources.delete2, new EventHandler(OnDeleteTextBox));
