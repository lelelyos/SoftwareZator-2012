...
namespace VelerSoftware.SZC.Obfuscator.Confuser.Core
{
    ...
    public class Confuser
    {
        ...
        {
            TypeDefinition att = new TypeDefinition("", "ObfuscatedBySoftwareZatorAttribute", TypeAttributes.Class | TypeAttributes.NotPublic, mod.Import(typeof(Attribute)));
            ...
            ca.ConstructorArguments.Add(new CustomAttributeArgument(mod.TypeSystem.String, string.Format("SoftwareZator's Obfuscator v" + typeof(Confuser).Assembly.GetName().Version.ToString())));
