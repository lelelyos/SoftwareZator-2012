...
namespace VelerSoftware.SZC.TreeViewMultiSelect
{
    ...
    #endregion TreeViewSelectionMode enumeration
    ...
    public class TreeViewMultiSelect : System.Windows.Forms.TreeView
    {
        ...
        #endregion SelectedNode, SelectionMode, SelectionBackColor, SelectedNodes + events
        ...
        private bool SelectNode(TreeNode tn, bool select, TreeViewAction tva)
        {
            ...
            if (select)
            {
                ...
                if (!IsNodeSelected(tn))
                {
                    ...
                    tn.ForeColor = ForeColor; // GKM moved from above
        ...
        #endregion OnMouseUp, OnMouseDown
    ...
    #endregion SelectedNodesCollection
}