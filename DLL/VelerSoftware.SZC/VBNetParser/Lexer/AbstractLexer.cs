...
namespace VelerSoftware.SZC.VBNetParser.Parser
{
	...
	internal abstract class AbstractLexer : ILexer
	{
		...
		/// <summary>
		/// The current Token. <seealso cref="VelerSoftware.SZC.VBNetParser.Parser.Token"/>
		/// </summary>
		public Token Token {
			get {
//				Console.WriteLine("Call to Token");
		...
		/// <summary>
		/// The next Token (The <see cref="Token"/> after <see cref="NextToken"/> call) . <seealso cref="VelerSoftware.SZC.VBNetParser.Parser.Token"/>
		/// </summary>
...
//			Console.WriteLine("Call to Peek");
		...
		public virtual Token NextToken()
		{
			if (curToken == null) {
				curToken = Next();
				//Console.WriteLine(VelerSoftware.SZC.VBNetParser.Parser.CSharp.Tokens.GetTokenString(curToken.kind) + " -- " + curToken.val + "(" + curToken.kind + ")");
				return curToken;
			}
