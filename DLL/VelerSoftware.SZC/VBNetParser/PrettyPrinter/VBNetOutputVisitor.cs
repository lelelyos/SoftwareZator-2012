...
namespace VelerSoftware.SZC.VBNetParser.PrettyPrinter
{
	public sealed class VBNetOutputVisitor : NodeTrackingAstVisitor, IOutputAstVisitor
	{
		...
		#region VelerSoftware.SZC.VBNetParser.Parser.IASTVisitor interface implementation
		...
		public override object TrackedVisitAttribute(VelerSoftware.SZC.VBNetParser.Ast.Attribute attribute, object data)
		{
