...
namespace VelerSoftware.SZC.VBNetParser.Ast
{
    ...
    public class AttributeSection : AbstractNode
    {
        ...
        List<VelerSoftware.SZC.VBNetParser.Ast.Attribute> attributes;
        ...
        public List<VelerSoftware.SZC.VBNetParser.Ast.Attribute> Attributes
        {
            get
            {
                return attributes;
    ...
    public class PropertyDeclaration : MemberNode
    {
        ...
        internal PropertyDeclaration(string name, TypeReference typeReference, Modifiers modifier, List<AttributeSection> attributes)
            : this(modifier, attributes, name, null)
        {
