...
using VelerSoftware.SZC.VBNetParser.AstBuilder;
using Attribute = VelerSoftware.SZC.VBNetParser.Ast.Attribute;
...
namespace VelerSoftware.SZC.VBNetParser.Visitors
{
	...
	public class ToVBNetConvertVisitor : ConvertVisitorBase
	{
		...
		bool ConvertPInvoke(MethodDeclaration method, VelerSoftware.SZC.VBNetParser.Ast.Attribute att)
		{
