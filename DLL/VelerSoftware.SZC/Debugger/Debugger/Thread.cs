...
namespace VelerSoftware.SZC.Debugger.Debugger
{
    public class Thread : DebuggerObject
    {
        ...
        public string GetStackTrace()
        {
            ...
            {
                return GetStackTrace(VelerSoftware.SZC.Properties.Resources.MainWindow_Windows_Debug_ExceptionForm_LineFormat_Symbols_EN, VelerSoftware.SZC.Properties.Resources.MainWindow_Windows_Debug_ExceptionForm_LineFormat_NoSymbols_EN);
            }
            else
            {
                return GetStackTrace(VelerSoftware.SZC.Properties.Resources.MainWindow_Windows_Debug_ExceptionForm_LineFormat_Symbols, VelerSoftware.SZC.Properties.Resources.MainWindow_Windows_Debug_ExceptionForm_LineFormat_NoSymbols);
            }
        }
