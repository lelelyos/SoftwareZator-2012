...
namespace VelerSoftware.SZC.Debugger.Debugger.Interop.MetaData
{
    ...
    public class MetaDataImport
    {
        ...
        private uint[] EnumerateTokens<T>(TokenEnumerator1<T> tokenEnumerator, T parameter)
        {
            IntPtr enumerator = IntPtr.Zero;
            uint[] buffer = new uint[DefaultBufferSize];
            uint fetched;
        ...
        private uint[] EnumerateTokens<T, R>(TokenEnumerator2<T, R> tokenEnumerator, T parameter1, R parameter2)
        {
            IntPtr enumerator = IntPtr.Zero;
            uint[] buffer = new uint[DefaultBufferSize];
            uint fetched;
