...
using VelerSoftware.SZC.VBNetParser.PrettyPrinter;
...
namespace VelerSoftware.SZC.VBNetParser.Ast
{
    public static class ExpressionExtensionMethods
    {
        ...
        private static M SetStaticType<M>(this M expr, DebugType type) where M : INode
        {
            expr.UserData = type;
            return expr;
        }
        ...
        public static Expression GetExpression(this string varName, System.Type varType)
        {
            return new IdentifierExpression(varName).SetStaticType((DebugType)varType);
        }
        ...
        private static List<Expression> AddExplicitTypes(MethodInfo method, Expression[] args)
        {
        ...
        private static string GetNameWithArgCounts(TypeReference typeRef)
        {
        ...
        public static DebugType ResolveType(this INode expr, VelerSoftware.SZC.Debugger.Debugger.AppDomain appDomain)
        {
        ...
        /// </summary>
        private static DebugType ResolveTypeInternal(TypeReference typeRef, DebugType[] genArgs, VelerSoftware.SZC.Debugger.Debugger.AppDomain appDomain)
        {
            DebugType type = null;
