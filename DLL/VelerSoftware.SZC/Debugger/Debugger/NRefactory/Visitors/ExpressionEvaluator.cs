...
namespace VelerSoftware.SZC.VBNetParser.Visitors
{
    ...
    public class ExpressionEvaluator : NotImplementedAstVisitor
    {
        ...
        private ExpressionEvaluator(StackFrame context)
        {
            this.context = context;
        }

        public static INode Parse(string code)
        {
        ...
        public static Value Evaluate(string code, StackFrame context)
        {
            return Evaluate(Parse(code), context);
        }
        ...
        private TypedValue Evaluate(INode expression)
        {
            return Evaluate(expression, true);
        }

        private TypedValue Evaluate(INode expression, bool permRef)
        {
        ...
        private List<TypedValue> EvaluateAll(List<Expression> exprs)
        {
        ...
        private int EvaluateAsInt(INode expression)
        {
        ...
        private TypedValue EvaluateAs(INode expression, DebugType type)
        {
        ...
        private Value[] GetValues(List<TypedValue> typedVals)
        {
        ...
        private DebugType[] GetTypes(List<TypedValue> typedVals)
        {
        ...
        private TypedValue CreateValue(object primitiveValue)
        {
        ...
        private TypedValue GetThisValue()
        {
        ...
        /// </summary>
        private object PerformUnaryOperation(object val, UnaryOperatorType op, Type argType)
        {
            checked
            {
        ...
        /// The arguments must be already converted to the correct types.
        /// </summary>
        private object PerformBinaryOperation(object left, object right, BinaryOperatorType op, Type argTypes)
        {
            checked
            {
        ...
        #endregion Binary and unary expressions
    }
}