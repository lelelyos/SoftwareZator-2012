...
namespace VelerSoftware.SZC.Debugger.Debugger
{
    ...
    public class Value : DebuggerObject
    {
        ...
        // May be called later
        private ICorDebugValue GetCorValueOfArrayElement(int[] indices)
        {
        ...
        private static void CheckObject(Value objectInstance, MemberInfo memberInfo)
        {
            if (memberInfo == null)
        ...
        #endregion Convenience overload methods
        ...
        private static ICorDebugValue GetFieldCorValue(Value objectInstance, FieldInfo fieldInfo)
        {
