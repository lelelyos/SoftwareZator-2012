...
namespace VelerSoftware.SZC.Debugger.Debugger.MetaData
{
    ...
    public class DebugType : System.Type, IDebugMemberInfo
    {
        ...
        private MemberInfo SelectOverload(MemberInfo[] candidates, Type[] argumentTypes)
        {
        ...
        private bool IsApplicable(ParameterInfo[] parameters, Type[] argumentTypes, out bool isExactMatch)
        {
            isExactMatch = false;
            if (argumentTypes == null)
                return true;
        ...
        private DebugType(AppDomain appDomain, ICorDebugType corType)
        {
            if (corType == null)
        ...
        private static Type GetPrimitiveType(string fullname)
        {
            switch (fullname)
            {
