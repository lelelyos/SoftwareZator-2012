...
namespace VelerSoftware.SZC.Debugger.Debugger
{
    ...
    internal class ManagedCallback
    {
        ...
        private void EnterCallback(PausedReason pausedReason, string name, ICorDebugAppDomain pAppDomain)
        {
        ...
        #endregion Program folow control
        ...
        #endregion Start of Application
        ...
        #endregion ICorDebugManagedCallback2 Members
    }
}