...
using VelerSoftware.SZC.Debugger.Base.Util;
...
namespace VelerSoftware.SZC.Debugger.Base.Gui
{
    ...
    public class SDWindowsFormsHost : WindowsFormsHost
    {
        ...
        private void CreateBindings(bool processShortcutsInWPF)
        {
        ...
        private static object GetServiceWrapper(Control ctl)
        {
        ...
        private sealed class TextBoxWrapper : IClipboardHandler, IUndoHandler
        {
            TextBoxBase textBox;
        ...
        private sealed class ComboBoxWrapper : IClipboardHandler
        {
            ...
            public void Cut() { comboBox.SelectedText = ""; }
