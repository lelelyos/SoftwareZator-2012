            ...
            if (version.StartsWith("@", StringComparison.OrdinalIgnoreCase))
            {
                if (version == "@SharpDevelopCoreVersion")
                {
                    if (entryVersion == null)
                        entryVersion = new Version(System.Environment.Version.Major + "." + System.Environment.Version.Minor + "." + System.Environment.Version.Build + "." + System.Environment.Version.Revision);
                    return entryVersion;
                }
                if (hintPath != null)
                {
