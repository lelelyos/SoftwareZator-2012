...
{
    /// <summary>
    /// Class that helps starting up VelerSoftware.SZC.Debugger.Core.
    /// </summary>
    /// <remarks>
    /// Initializing VelerSoftware.SZC.Debugger.Core requires initializing several static classes
    ...
    public sealed class CoreStartup
    {
        ...
        private sealed class AppNameProvider : IStringTagProvider
        {
