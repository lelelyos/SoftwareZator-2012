...
namespace VelerSoftware.SZC.Debugger.Core
{
    ...
    public static partial class FileUtility
    {
        ...
        public static bool IsValidPath(string fileName)
        {
            ...
            return !((nameWithoutExtension.StartsWith("COM", StringComparison.OrdinalIgnoreCase) ||
        ...
        private static FileOperationResult ObservedSaveHandleException(Exception e, FileOperationDelegate saveFile, string fileName, string message, FileErrorPolicy policy)
        {
            switch (policy)
            {
        ...
        private static FileOperationResult ObservedLoadHandleException(Exception e, FileOperationDelegate loadFile, string fileName, string message, FileErrorPolicy policy)
        {
            switch (policy)
            {
                case FileErrorPolicy.Inform:
