...
{
    /// <summary>
    /// A minimal version of FileUtility. Is used by VelerSoftware.SZC.Debugger.Interfaces (which doesn't reference
    /// VelerSoftware.SZC.Debugger.Core)
    /// </summary>
    static partial class FileUtility
    {
        ...
        public static string NormalizePath(string fileName)
        {
            ...
            if (isWeb == false && fileName.StartsWith(@"\\", StringComparison.OrdinalIgnoreCase) || fileName.StartsWith("//", StringComparison.OrdinalIgnoreCase))
            {
                i = 2;
