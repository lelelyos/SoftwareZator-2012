...
using VelerSoftware.SZC.TreeViewAdv.Tree;
...
namespace VelerSoftware.SZC.Debugger.TreeModel
{
    ...
    public class TreeViewVarNode : TreeNodeAdv
    {
        ...
        VelerSoftware.SZC.TreeViewAdv.Tree.TreeViewAdv localVarList;
        VelerSoftware.SZC.Debugger.Debugger.Process process;
        TreeNode content;
        ...
        public override void OnExpanding()
        {
            base.OnExpanding();
        }
        ...
        public override void OnCollapsing()
        {
            base.OnCollapsing();
        }
