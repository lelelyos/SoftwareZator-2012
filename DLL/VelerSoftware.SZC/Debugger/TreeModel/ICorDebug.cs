...
namespace VelerSoftware.SZC.Debugger.TreeModel
{
    public class ICorDebug
    {
        public class InfoNode : TreeNode
        {
            ...
            public InfoNode(string name, string text)
                : this(name, text, null)
            {
            }
        ...
        public static InfoNode GetDebugInfoRoot(VelerSoftware.SZC.Debugger.Debugger.AppDomain appDomain, ICorDebugValue corValue)
        {
            return new InfoNode("ICorDebug", "", GetDebugInfo(appDomain, corValue));
        }

        public static List<TreeNode> GetDebugInfo(VelerSoftware.SZC.Debugger.Debugger.AppDomain appDomain, ICorDebugValue corValue)
        {
