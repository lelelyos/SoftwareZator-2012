...
namespace VelerSoftware.SZC35.Editing
{
	...
	static class EditingCommandHandler
	{
		...
		static EditingCommandHandler()
		{
			...
			CommandBindings.Add(new CommandBinding(SZC35Commands.DeleteLine, OnDeleteLine));
			
			CommandBindings.Add(new CommandBinding(SZC35Commands.RemoveLeadingWhitespace, OnRemoveLeadingWhitespace));
			CommandBindings.Add(new CommandBinding(SZC35Commands.RemoveTrailingWhitespace, OnRemoveTrailingWhitespace));
			CommandBindings.Add(new CommandBinding(SZC35Commands.ConvertToUppercase, OnConvertToUpperCase));
			CommandBindings.Add(new CommandBinding(SZC35Commands.ConvertToLowercase, OnConvertToLowerCase));
			CommandBindings.Add(new CommandBinding(SZC35Commands.ConvertToTitleCase, OnConvertToTitleCase));
			CommandBindings.Add(new CommandBinding(SZC35Commands.InvertCase, OnInvertCase));
			CommandBindings.Add(new CommandBinding(SZC35Commands.ConvertTabsToSpaces, OnConvertTabsToSpaces));
			CommandBindings.Add(new CommandBinding(SZC35Commands.ConvertSpacesToTabs, OnConvertSpacesToTabs));
			CommandBindings.Add(new CommandBinding(SZC35Commands.ConvertLeadingTabsToSpaces, OnConvertLeadingTabsToSpaces));
			CommandBindings.Add(new CommandBinding(SZC35Commands.ConvertLeadingSpacesToTabs, OnConvertLeadingSpacesToTabs));
			CommandBindings.Add(new CommandBinding(SZC35Commands.IndentSelection, OnIndentSelection));
		}
