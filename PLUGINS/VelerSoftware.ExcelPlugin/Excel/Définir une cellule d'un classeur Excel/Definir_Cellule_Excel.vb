<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Definir_Cellule_Excel_Designer))> _
Public Class Definir_Cellule_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Definir_Cellule_Excel", GetType(Definir_Cellule_Excel).Assembly)
        Using frm As New Definir_Cellule_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "SetCellValue", New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param2, True)), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param3, True)))
            Else
                Return Nothing
            End If
        End If
