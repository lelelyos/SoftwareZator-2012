<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Ajouter_Feuille_Excel_Designer))> _
Public Class Ajouter_Feuille_Excel
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Ajouter_Feuille_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Ajouter_Feuille_Excel", GetType(Ajouter_Feuille_Excel).Assembly)
        Using frm As New Ajouter_Feuille_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "AddWorksheet", New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param2, True)))
            Else
                Return Nothing
            End If
        End If
