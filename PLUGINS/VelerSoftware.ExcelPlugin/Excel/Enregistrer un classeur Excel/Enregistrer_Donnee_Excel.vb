<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Enregistrer_Donnee_Excel_Designer))> _
Public Class Enregistrer_Donnee_Excel
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Enregistrer_Donnee_Excel", GetType(Enregistrer_Donnee_Excel).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.Enregistrer_Donnee_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Enregistrer_Donnee_Excel", GetType(Enregistrer_Donnee_Excel).Assembly)
        Using frm As New Enregistrer_Donnee_Excel_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                ...
                Else
                    saveas = ""
                End If
                If Not CBool(Me.Param2) Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "Save")
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "Save" & saveas, New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param3, True)))
                End If
            Else
                Return Nothing
            End If
