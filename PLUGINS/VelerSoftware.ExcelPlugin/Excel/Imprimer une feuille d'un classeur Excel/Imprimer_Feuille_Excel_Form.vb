Public Class Imprimer_Feuille_Excel_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.CheckBox1.Checked Then
            strr = "PrintAllWorksheets"
        Else
            strr = "PrintWorksheet"
        End If
        Dim OperationStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Boutons_ComboBox.Text), strr, New CodeDom.CodePrimitiveExpression(1))
