<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Imprimer_Feuille_Excel_Designer))> _
Public Class Imprimer_Feuille_Excel
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Imprimer_Feuille_Excel", GetType(Imprimer_Feuille_Excel).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.Imprimer_Feuille_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Imprimer_Feuille_Excel", GetType(Imprimer_Feuille_Excel).Assembly)
        Using frm As New Imprimer_Feuille_Excel_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If CBool(Param2) Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "PrintAllWorksheets", New CodeDom.CodePrimitiveExpression(1))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "PrintWorksheet", New CodeDom.CodePrimitiveExpression(1))
                End If
            Else
                Return Nothing
            End If
