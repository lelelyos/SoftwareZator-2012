Public Class Ouvrir_Fichier_Excel_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        Dim OperationStatement As New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Boutons_ComboBox.Text), New CodeDom.CodeSnippetExpression("New VelerSoftware.ExcelLib.Wrapper(" & Me.Tools.TransformKeyVariables(Me.Hote_ActionTextBox1.Text, True) & ", " & Me.CheckBox1.Checked & ")"))
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodeObjectCreateExpression Then
                    If TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Left Is CodeDom.CodeVariableReferenceExpression Then
                        ...
                        Me.Hote_ActionTextBox1.Text = CStr(DirectCast(DirectCast(DirectCast(sta, CodeDom.CodeAssignStatement).Right, CodeDom.CodeObjectCreateExpression).Parameters(0), CodeDom.CodePrimitiveExpression).Value)
                        Me.CheckBox1.Checked = CBool(DirectCast(DirectCast(DirectCast(sta, CodeDom.CodeAssignStatement).Right, CodeDom.CodeObjectCreateExpression).Parameters(1), CodeDom.CodePrimitiveExpression).Value)
                    End If
                End If
