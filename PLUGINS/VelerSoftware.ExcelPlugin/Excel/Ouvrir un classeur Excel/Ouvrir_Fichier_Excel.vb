<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Ouvrir_Fichier_Excel_Designer))> _
Public Class Ouvrir_Fichier_Excel
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Ouvrir_Fichier_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Ouvrir_Fichier_Excel", GetType(Ouvrir_Fichier_Excel).Assembly)
        Using frm As New Ouvrir_Fichier_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("New VelerSoftware.ExcelLib.Wrapper(" & Me.Tools.TransformKeyVariables(Me.Param3, True) & ", " & Me.Param2 & ")"))
            Else
                Return Nothing
            End If
        End If
