<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Supprimer_Feuille_Excel_Designer))> _
Public Class Supprimer_Feuille_Excel
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Supprimer_Feuille_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Supprimer_Feuille_Excel", GetType(Supprimer_Feuille_Excel).Assembly)
        Using frm As New Supprimer_Feuille_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "DeleteWorksheet", New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param2, True)))
            Else
                Return Nothing
            End If
        End If
