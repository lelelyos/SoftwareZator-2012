<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Obtenir_Cellule_Excel_Designer))> _
Public Class Obtenir_Cellule_Excel
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.cellule
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Obtenir_Cellule_Excel", GetType(Obtenir_Cellule_Excel).Assembly)
        Using frm As New Obtenir_Cellule_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param3), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "GetCellValue", New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param2, True))))
            Else
                Return Nothing
            End If
        End If
