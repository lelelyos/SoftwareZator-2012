<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Obtenir_Liste_Feuille_Excel_Designer))> _
Public Class Obtenir_Liste_Feuille_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Obtenir_Liste_Feuille_Excel", GetType(Obtenir_Liste_Feuille_Excel).Assembly)
        Using frm As New Obtenir_Liste_Feuille_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param3), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "WorksheetNames"))
            Else
                Return Nothing
            End If
        End If
