<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Fermer_Donnee_Excel_Designer))> _
Public Class Fermer_Donnee_Excel
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Fermer_Donnee_Excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Fermer_Donnee_Excel", GetType(Fermer_Donnee_Excel).Assembly)
        Using frm As New Fermer_Donnee_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "Close")
            Else
                Return Nothing
            End If
        End If
