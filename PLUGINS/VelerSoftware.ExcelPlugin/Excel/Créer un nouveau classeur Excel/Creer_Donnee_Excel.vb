<System.ComponentModel.Designer(GetType(VelerSoftware.ExcelPlugin.Creer_Donnee_Excel_Designer))> _
Public Class Creer_Donnee_Excel
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.creer_donnee_excel
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.ExcelPlugin.Creer_Donnee_Excel", GetType(Creer_Donnee_Excel).Assembly)
        Using frm As New Creer_Donnee_Excel_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("New VelerSoftware.ExcelLib.Wrapper(" & Me.Param2 & ")"))
            Else
            Return Nothing
        End If
        End If
