<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Definir_Marges_Designer))> _
Public Class Definir_Marges
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.set_margin
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Definir_Marges", GetType(Definir_Marges).Assembly)
        Using frm As New Definir_Marges_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".setMargin(" & Me.Param2 & ")")
            Else
                Return Nothing
            End If
        End If
