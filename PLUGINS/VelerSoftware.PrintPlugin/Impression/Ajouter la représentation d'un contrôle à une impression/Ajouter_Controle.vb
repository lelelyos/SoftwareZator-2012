<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Ajouter_Controle_Designer))> _
Public Class Ajouter_Controle
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.document_block
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Ajouter_Controle", GetType(Ajouter_Controle).Assembly)
        Using frm As New Ajouter_Controle_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".SetDocument(" & Me.Param5.Split(" ")(0) & ", " & Me.Tools.TransformKeyVariables(Me.Param3, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Param4, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
            Else
                Return Nothing
            End If
        End If
