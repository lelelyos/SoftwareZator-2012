<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Imprimer_Designer))> _
Public Class Imprimer
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Imprimer", GetType(Imprimer).Assembly)
        Using frm As New Imprimer_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param4 = Nothing Then
                    Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".Print(" & Me.Param2 & ", " & Me.Param3 & ")")
                Else
                    Return New CodeDom.CodeSnippetExpression(Me.Param4 & " = " & Me.Param1 & ".Print(" & Me.Param2 & ", " & Me.Param3 & ")")
                End If
            Else
                Return Nothing
            End If
