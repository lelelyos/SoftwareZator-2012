<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Ajouter_Image_Designer))> _
Public Class Ajouter_Image
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.document_image
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Ajouter_Image", GetType(Ajouter_Image).Assembly)
        Using frm As New Ajouter_Image_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".AddImage(" & Me.Param7 & ", " & Me.Tools.TransformKeyVariables(Me.Param3, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Param4, False, False) & ", DirectCast(" & Me.Param7 & ", System.Drawing.Bitmap).Width,  DirectCast(" & Me.Param7 & ", System.Drawing.Bitmap).Height, " & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
            Else
                Return Nothing
            End If
        End If
