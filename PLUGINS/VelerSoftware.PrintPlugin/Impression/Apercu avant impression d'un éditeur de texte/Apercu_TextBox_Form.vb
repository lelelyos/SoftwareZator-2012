Public Class Apercu_TextBox_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeSnippetExpression("Using PrintTextAera_abhdx As New VelerSoftware.PrintLib.PrintSystem.PrintRichTextBox(Me." & Me.Boutons_ComboBox.Text.Substring(3) & ")" & Environment.NewLine & "PrintTextAera_abhdx.PrintPreview()" & Environment.NewLine & "End Using")
        Else
            OperationStatement = New CodeDom.CodeSnippetExpression("Using PrintTextAera_abhdx As New VelerSoftware.PrintLib.PrintSystem.PrintRichTextBox(Variables." & Me.Boutons_ComboBox.Text & ")" & Environment.NewLine & "PrintTextAera_abhdx.PrintPreview()" & Environment.NewLine & "End Using")
        End If
