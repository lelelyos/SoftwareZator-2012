<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Ajouter_Texte_Designer))> _
Public Class Ajouter_Texte
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Ajouter_Texte", GetType(Ajouter_Texte).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.document_text
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Ajouter_Texte", GetType(Ajouter_Texte).Assembly)
        Using frm As New Ajouter_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".AddText(New System.Drawing.Point(" & Me.Tools.TransformKeyVariables(Me.Param3, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Param4, False, False) & "), " & Me.Tools.TransformKeyVariables(Me.Param8, True) & ", " & Me.Param7 & ", " & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
            Else
                Return Nothing
            End If
        End If
