<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Nouvelle_Impression_Designer))> _
Public Class Nouvelle_Impression
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.printer_add
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Nouvelle_Impression", GetType(Nouvelle_Impression).Assembly)
        Using frm As New Nouvelle_Impression_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param1 & " = New VelerSoftware.PrintLib.PrintSystem.PrintClass(VelerSoftware.PrintLib.PrintSystem.Orientation." & Param3 & ", " & Me.Tools.TransformKeyVariables(Me.Param2, True) & ", False)")
            Else
                Return Nothing
            End If
        End If
