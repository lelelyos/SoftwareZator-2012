<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Ajouter_Enete_Impression_Designer))> _
Public Class Ajouter_Enete_Impression
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.document_hf
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Ajouter_Enete_Impression", GetType(Ajouter_Enete_Impression).Assembly)
        Using frm As New Ajouter_Enete_Impression_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".setEntete(" & Me.Tools.TransformKeyVariables(Me.Param2, True) & ", VelerSoftware.PrintLib.PrintSystem.Alignement." & Me.Param3 & ", VelerSoftware.PrintLib.PrintSystem.HeaderType." & Me.Param4 & ", " & Me.Param5 & ")")
            Else
                Return Nothing
            End If
        End If
