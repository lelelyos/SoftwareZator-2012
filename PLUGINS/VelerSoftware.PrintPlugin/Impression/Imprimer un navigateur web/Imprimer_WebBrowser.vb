<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Imprimer_WebBrowser_Designer))> _
Public Class Imprimer_WebBrowser
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Imprimer_WebBrowser", GetType(Imprimer_WebBrowser).Assembly)
        Using frm As New Imprimer_WebBrowser_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeSnippetExpression("Me." & Me.Param1.Substring(3) & ".Print()")
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".Print()")
                End If
            Else
                Return Nothing
            End If
