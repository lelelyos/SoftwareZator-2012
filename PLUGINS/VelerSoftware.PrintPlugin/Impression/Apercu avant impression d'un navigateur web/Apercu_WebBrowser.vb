<System.ComponentModel.Designer(GetType(VelerSoftware.PrintPlugin.Apercu_WebBrowser_Designer))> _
Public Class Apercu_WebBrowser
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.PrintPlugin.Apercu_WebBrowser", GetType(Apercu_WebBrowser).Assembly)
        Using frm As New Apercu_WebBrowser_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeSnippetExpression("Me." & Me.Param1.Substring(3) & ".ShowPrintPreviewDialog()")
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".ShowPrintPreviewDialog()")
                End If
            Else
                Return Nothing
            End If
