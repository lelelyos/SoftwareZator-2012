Public Class Vider_DataGridView_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeSnippetExpression("Me." & Me.Boutons_ComboBox.Text.Substring(3) & ".Rows.Clear() : Me." & Me.Boutons_ComboBox.Text.Substring(3) & ".Columns.Clear()")
        Else
            OperationStatement = New CodeDom.CodeSnippetExpression("Variables." & Me.Boutons_ComboBox.Text & ".Rows.Clear() : Variables." & Me.Boutons_ComboBox.Text & ".Columns.Clear()")
        End If
