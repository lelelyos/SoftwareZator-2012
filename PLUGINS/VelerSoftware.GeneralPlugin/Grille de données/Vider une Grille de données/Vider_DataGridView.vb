<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Vider_DataGridView_Designer))> _
Public Class Vider_DataGridView
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.supprimer_ligne_datagridview
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Vider_DataGridView", GetType(Vider_DataGridView).Assembly)
        Using frm As New Vider_DataGridView_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1.StartsWith("Me.") Then
                        Return New CodeDom.CodeSnippetExpression("Me." & Me.Param1.Substring(3) & ".Rows.Clear() : Me." & Me.Param1.Substring(3) & ".Columns.Clear()")
                    Else
                        Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".Rows.Clear() : Variables." & Me.Param1 & ".Columns.Clear()")
                    End If
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".Rows.Clear() : Variables." & Me.Param1 & ".Columns.Clear()")
                End If
