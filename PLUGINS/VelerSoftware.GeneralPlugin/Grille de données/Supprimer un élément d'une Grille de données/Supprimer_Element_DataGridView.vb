<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Supprimer_Element_DataGridView_Designer))> _
Public Class Supprimer_Element_DataGridView
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Supprimer_Element_DataGridView", GetType(Supprimer_Element_DataGridView).Assembly)
        Using frm As New Supprimer_Element_DataGridView_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeSnippetExpression("Me." & Me.Param1.Substring(3) & ".Rows.RemoveAt(" & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".Rows.RemoveAt(" & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
                End If
            Else
                Return Nothing
            End If
