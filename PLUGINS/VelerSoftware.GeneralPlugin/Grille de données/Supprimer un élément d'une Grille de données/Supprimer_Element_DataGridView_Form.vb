Public Class Supprimer_Element_DataGridView_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeSnippetExpression("Me." & Me.Boutons_ComboBox.Text.Substring(3) & ".Rows.RemoveAt(" & Me.Tools.TransformKeyVariables(Me.ActionTextBox1.Text, False, False) & ")")
        Else
            OperationStatement = New CodeDom.CodeSnippetExpression("Variables." & Me.Boutons_ComboBox.Text & ".Rows.RemoveAt(" & Me.Tools.TransformKeyVariables(Me.ActionTextBox1.Text, False, False) & ")")
        End If
