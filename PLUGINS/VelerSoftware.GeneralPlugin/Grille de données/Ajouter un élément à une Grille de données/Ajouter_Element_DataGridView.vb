<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Ajouter_Element_DataGridView_Designer))> _
Public Class Ajouter_Element_DataGridView
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.ajouter_ligne_datagridview
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Ajouter_Element_DataGridView", GetType(Ajouter_Element_DataGridView).Assembly)
        Using frm As New Ajouter_Element_DataGridView_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                For Each strr As String In Me.Param2.Split("█")
                    param &= Me.Tools.TransformKeyVariables(strr, True) & ","
                Next
                If param IsNot Nothing Then param = param.TrimEnd(",")
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeSnippetExpression("Me." & Me.Param1.Substring(3) & ".Rows.Add(New String() {" & param & "})")
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".Rows.Add(New String() {" & param & "})")
                End If
            Else
                Return Nothing
            End If
