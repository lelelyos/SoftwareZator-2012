<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Modifier_Sous_Element_ListView_Designer))> _
Public Class Modifier_Sous_Element_ListView
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.modifier_item_listview
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Modifier_Sous_Element_ListView", GetType(Modifier_Sous_Element_ListView).Assembly)
        Using frm As New Modifier_Sous_Element_ListView_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".SubItems(" & Me.Tools.TransformKeyVariables(Me.Param3, False, False) & ").Text = " & Me.Tools.TransformKeyVariables(Me.Param2, True))
            Else
                Return Nothing
            End If
        End If
