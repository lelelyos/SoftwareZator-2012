Public Class Executer_Fonction_Paramètre_Form
    ...
    Private Sub FonctionForm_OnOKButtonClicked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnOKButtonClicked
        With Me
            If .Boutons_ComboBox.Text = "" OrElse .ActionTextBox1.Text = "" OrElse .Var1_ComboBox.Text = "" Then
    ...
    Private Sub ActionTextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ActionTextBox1.TextChanged
        If Not Me.ActionTextBox1.Text = "" Then Me.Boutons_ComboBox.Enabled = True
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        If Me.Boutons_ComboBox.Text = "" OrElse Me.ActionTextBox1.Text = "" OrElse Me.Var1_ComboBox.Text = "" Then
            MsgBox(RM.GetString("Formulaire_Incomplet"), MsgBoxStyle.Exclamation)
            Exit Sub
        End If
        ...
        If Me.ComboBox1.Enabled AndAlso (Not Me.ComboBox1.Text = Nothing) Then
            ...
            Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeVariableReferenceExpression("My.Settings." & Me.Var1_ComboBox.Text), Me.Boutons_ComboBox.Text.Split(" ")(0), New CodeDom.CodeSnippetExpression(param))
