<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Supprimer_Element_CheckedListBox_Designer))> _
Public Class Supprimer_Element_CheckedListBox
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Supprimer_Element_CheckedListBox", GetType(Supprimer_Element_CheckedListBox).Assembly)
        Using frm As New Supprimer_Element_CheckedListBox_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeSnippetExpression("Me." & Me.Param1.Substring(3) & ".Items.RemoveAt(" & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".Items.RemoveAt(" & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
                End If
            Else
                Return Nothing
            End If
