<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Fenêtres_Ouvertes_Designer))> _
Public Class Obtenir_Fenêtres_Ouvertes
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Obtenir_Fenêtres_Ouvertes
            .CompatibleClass = False
            .CompatibleFonctions = True
            .FileHelp = RM.GetString("Help_File")

            .ClassCode = "VelerSoftware.GeneralPlugin.Obtenir_Fenêtres_Ouvertes.vb"
    ...
    Public Overrides Function Main() As Boolean
        ...
        Using frm As New Obtenir_Fenêtres_Ouvertes_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_GeneralPlugin"), "GetOpenForms"))
            Else
                Return Nothing
            End If
        End If
