<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Ajouter_Fenetre_Enfant_Designer))> _
Public Class Ajouter_Fenetre_Enfant
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.ajouter_fenetre_enfant
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Ajouter_Fenetre_Enfant", GetType(Ajouter_Fenetre_Enfant).Assembly)
        Using frm As New Ajouter_Fenetre_Enfant_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim parent As String = Me.Param1
                If Not parent = "Me" Then parent = "Variables." & parent
                Return New CodeDom.CodeSnippetStatement(Me.Param4 & " = New " & Me.Param2 & " : " & Me.Param4 & ".Name = " & Me.Tools.TransformKeyVariables(Me.Param3, True) & " : " & Me.Param4 & ".MdiParent = " & parent & " : " & Me.Param4 & ".Visible = True")
            Else
                Return Nothing
            End If
        End If
