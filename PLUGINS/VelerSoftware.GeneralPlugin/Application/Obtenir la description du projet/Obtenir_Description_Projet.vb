<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Description_Projet_Designer))> _
Public Class Obtenir_Description_Projet
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Description_Projet", GetType(Obtenir_Description_Projet).Assembly)
        Using frm As New Obtenir_Description_Projet_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("_manager.Info.Description"))
                Else
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("My.Application.Info.Description"))
                End If
            Else
                Return Nothing
            End If
