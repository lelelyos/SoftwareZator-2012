Public Class Obtenir_Produit_Projet_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        Dim OperationStatement As New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Boutons_ComboBox.Text), New CodeDom.CodeSnippetExpression("My.Application.Info.ProductName"))
        ...
        If (Not sender Is Nothing) AndAlso (sender.Namespaces.Count > 0) Then
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodePropertyReferenceExpression Then
                    ...
                    MsgBox(DirectCast(sta, CodeDom.CodeAssignStatement).Right.GetType.FullName)
                    metho = DirectCast(DirectCast(sta, CodeDom.CodeAssignStatement).Right, CodeDom.CodePropertyReferenceExpression)
                    If metho.PropertyName = "ProductName" AndAlso TypeOf metho.TargetObject Is CodeDom.CodeTypeReferenceExpression AndAlso DirectCast(metho.TargetObject, CodeDom.CodeTypeReferenceExpression).Type.BaseType = "My.Application.Info" Then
