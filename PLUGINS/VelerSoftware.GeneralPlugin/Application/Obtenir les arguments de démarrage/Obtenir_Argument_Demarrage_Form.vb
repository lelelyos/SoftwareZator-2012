Public Class Obtenir_Argument_Demarrage_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            .Param2 = Me.Tools.GetCurrentFunctionName & "|" & Me.Tools.GetCurrentDocumentName
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Param2 = "Startup|ApplicationEvents.szc" OrElse Me.Param2 = "StartupNextInstance|ApplicationEvents.szc" Then
            OperationStatement = New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Boutons_ComboBox.Text), New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of System.Object)(DirectCast(_e, Microsoft.VisualBasic.ApplicationServices." & Me.Param2.Split("|")(0) & "EventArgs).CommandLine)"))
        Else
            OperationStatement = New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Boutons_ComboBox.Text), New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of System.Object)(System.Environment.GetCommandLineArgs())"))
        End If
    ...
    Private Sub FonctionForm_OnParseCodeButtonClick(ByVal sender As CodeDom.CodeCompileUnit, ByVal e As System.EventArgs) Handles MyBase.OnParseCodeButtonClick
        If (Not sender Is Nothing) AndAlso (sender.Namespaces.Count > 0) Then
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodeObjectCreateExpression Then
                    ...
                    If metho.CreateType.BaseType.StartsWith("System.Collections.Generic.List") Then
