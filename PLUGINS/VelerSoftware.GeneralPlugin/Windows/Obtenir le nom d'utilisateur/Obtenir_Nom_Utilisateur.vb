<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Nom_Utilisateur_Designer))> _
Public Class Obtenir_Nom_Utilisateur
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.nom_utilisateur
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Nom_Utilisateur", GetType(Obtenir_Nom_Utilisateur).Assembly)
        Using frm As New Obtenir_Nom_Utilisateur_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("System.Environment.UserName"))
            Else
                Return Nothing
            End If
        End If
