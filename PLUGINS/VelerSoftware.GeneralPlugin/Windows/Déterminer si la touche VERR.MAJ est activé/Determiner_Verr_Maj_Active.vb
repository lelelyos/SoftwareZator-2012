<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Determiner_Verr_Maj_Active_Designer))> _
Public Class Determiner_Verr_Maj_Active
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.verr_maj
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Determiner_Verr_Maj_Active", GetType(Determiner_Verr_Maj_Active).Assembly)
        Using frm As New Determiner_Verr_Maj_Active_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("System.Console.CapsLock"))
            Else
                Return Nothing
            End If
        End If
