<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Version_Net_Designer))> _
Public Class Obtenir_Version_Net
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.version_net
            ...
            .ClassCode = "VelerSoftware.GeneralPlugin.Obtenir_Version_Net.vb"
        End With
    End Sub
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Version_Net", GetType(Obtenir_Version_Net).Assembly)
        Using frm As New Obtenir_Version_Net_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_GeneralPlugin"), "GetFrameworkVersion"))
            Else
                Return Nothing
            End If
        End If
