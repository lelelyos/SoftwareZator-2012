<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Arreter_Processus_Designer))> _
Public Class Arreter_Processus
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.tuer_processus
            ...
            .ClassCode = "VelerSoftware.GeneralPlugin.Tuer_Processus.vb"
        End With
    End Sub
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Arreter_Processus", GetType(Arreter_Processus).Assembly)
        Using frm As New Arreter_Processus_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_GeneralPlugin"), "KillProc"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodePrimitiveExpression(CBool(Me.Param2)))
            Else
                Return Nothing
            End If
        End If
