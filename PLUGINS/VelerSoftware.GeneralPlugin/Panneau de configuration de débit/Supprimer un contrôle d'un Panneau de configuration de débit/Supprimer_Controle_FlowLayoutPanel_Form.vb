Public Class Supprimer_Controle_FlowLayoutPanel_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            If Not .Param2 = Nothing Then
                .Annee_ActionTextBox1.Text = .Param2
            End If
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Boutons_ComboBox.Text.Substring(3) & ".Controls"), "RemoveByKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Annee_ActionTextBox1.Text, True)))
        Else
            OperationStatement = New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Boutons_ComboBox.Text & ".Controls"), "RemoveByKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Annee_ActionTextBox1.Text, True)))
        End If
