Public Class Aller_Etiquette_Designer

    Private Sub ActionChanged(ByVal sender As System.Object, ByVal propertyName As String, ByVal e As System.EventArgs)
        If propertyName = "Param1" Then Me.TextBox1.Text = DirectCast(Me.ModelItem.GetCurrentValue, Aller_Etiquette).Param1
    End Sub
    ...
    Private Sub ActivityDesigner_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        Me.TextBox1.Text = DirectCast(Me.ModelItem.GetCurrentValue, Aller_Etiquette).Param1

        AddHandler DirectCast(Me.ModelItem.GetCurrentValue, Aller_Etiquette).ActionChanged, AddressOf ActionChanged
    End Sub
