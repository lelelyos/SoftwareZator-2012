<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Etiquette_Designer))> _
Public Class Etiquette
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Etiquette", GetType(Etiquette).Assembly)
        Using frm As New Etiquette_Form
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeLabeledStatement(Me.Param1)
            Else
                Return Nothing
            End If
        End If
