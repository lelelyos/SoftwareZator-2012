<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Modifier_Point_Diagramme_Designer))> _
Public Class Modifier_Point_Diagramme
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Modifier_Point_Diagramme", GetType(Modifier_Point_Diagramme).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.Modifier_Point_Diagramme
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Modifier_Point_Diagramme", GetType(Modifier_Point_Diagramme).Assembly)
        Using frm As New Modifier_Point_Diagramme_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeSnippetExpression("Me." & Param1.Substring(3) & ".Series(" & Me.Tools.TransformKeyVariables(Param2, True) & ").Points(" & Me.Tools.TransformKeyVariables(Param3, False) & ").SetValueY(" & Me.Tools.TransformKeyVariables(Param4, False) & ")")
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Param1 & ".Series(" & Me.Tools.TransformKeyVariables(Param2, True) & ").Points(" & Me.Tools.TransformKeyVariables(Param3, False) & ").SetValueY(" & Me.Tools.TransformKeyVariables(Param4, False) & ")")
                End If
            Else
                Return Nothing
            End If
