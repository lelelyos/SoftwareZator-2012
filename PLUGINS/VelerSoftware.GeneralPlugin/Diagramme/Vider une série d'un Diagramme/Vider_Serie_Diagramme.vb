<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Vider_Serie_Diagramme_Designer))> _
Public Class Vider_Serie_Diagramme
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Vider_Serie_Diagramme", GetType(Vider_Serie_Diagramme).Assembly)
        Using frm As New Vider_Serie_Diagramme_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeSnippetExpression("Me." & Param1.Substring(3) & ".Series(" & Me.Tools.TransformKeyVariables(Param2, True) & ").Points().Clear()")
                Else
                    Return New CodeDom.CodeSnippetExpression("Variables." & Param1 & ".Series(" & Me.Tools.TransformKeyVariables(Param2, True) & ").Points().Clear()")
                End If
            Else
                Return Nothing
            End If
