<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Coller_TextBox_Designer))> _
Public Class Coller_TextBox
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Coller_editeur_texte
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Coller_TextBox", GetType(Coller_TextBox).Assembly)
        Using frm As New Coller_TextBox_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1.StartsWith("Me.") Then
                        Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Param1.Substring(3)), "Paste"))
                    Else
                        Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "Paste"))
                    End If
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "Paste"))
                End If
