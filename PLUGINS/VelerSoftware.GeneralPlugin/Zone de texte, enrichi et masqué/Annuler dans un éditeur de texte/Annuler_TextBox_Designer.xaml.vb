Public Class Annuler_TextBox_Designer

    Private Sub ActionChanged(ByVal sender As System.Object, ByVal propertyName As String, ByVal e As System.EventArgs)
        If propertyName = "Param1" Then Me.ComboBox1.Text = DirectCast(Me.ModelItem.GetCurrentValue, Annuler_TextBox).Param1
    End Sub
    ...
    Private Sub ActivityDesigner_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        For Each aaa As VelerSoftware.Plugins3.Windows.Core.Object In DirectCast(Me.ModelItem.GetCurrentValue, Annuler_TextBox).Tools.GetCurrentProjectWindowsControls
        ...
        Me.ComboBox1.SelectedItem = DirectCast(Me.ModelItem.GetCurrentValue, Annuler_TextBox).Param1

        AddHandler DirectCast(Me.ModelItem.GetCurrentValue, Annuler_TextBox).ActionChanged, AddressOf ActionChanged
    End Sub
