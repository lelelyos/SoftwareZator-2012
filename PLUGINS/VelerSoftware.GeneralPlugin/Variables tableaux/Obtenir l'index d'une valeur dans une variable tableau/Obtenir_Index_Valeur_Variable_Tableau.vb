<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Index_Valeur_Variable_Tableau_Designer))> _
Public Class Obtenir_Index_Valeur_Variable_Tableau
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Index_Valeur_Variable_Tableau", GetType(Obtenir_Index_Valeur_Variable_Tableau).Assembly)
        Using frm As New Obtenir_Index_Valeur_Variable_Tableau_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param5), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeVariableReferenceExpression(Me.Param1), "IndexOf"), New CodeDom.CodeSnippetExpression(Me.Param3)))
            Else
                Return Nothing
            End If
        End If
