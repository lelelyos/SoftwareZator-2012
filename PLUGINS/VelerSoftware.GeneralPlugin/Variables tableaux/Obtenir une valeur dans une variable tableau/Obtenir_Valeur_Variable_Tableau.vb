<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Valeur_Variable_Tableau_Designer))> _
Public Class Obtenir_Valeur_Variable_Tableau
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Valeur_Variable_Tableau", GetType(Obtenir_Valeur_Variable_Tableau).Assembly)
        Using frm As New Obtenir_Valeur_Variable_Tableau_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeSnippetExpression(Me.Param3 & " = " & Me.Param1 & "(" & Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ")")
            Else
                Return Nothing
            End If
        End If
