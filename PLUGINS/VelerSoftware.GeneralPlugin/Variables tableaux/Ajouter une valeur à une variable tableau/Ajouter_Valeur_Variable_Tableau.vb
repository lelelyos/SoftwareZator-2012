<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Ajouter_Valeur_Variable_Tableau_Designer))> _
Public Class Ajouter_Valeur_Variable_Tableau
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Ajouter_Valeur_Variable_Tableau", GetType(Ajouter_Valeur_Variable_Tableau).Assembly)
        Using frm As New Ajouter_Valeur_Variable_Tableau_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                ...
                If CBool(Me.Param5) Then
                    Return New CodeDom.CodeMethodInvokeExpression(VariableStatement, "Add", MsgBoxStatement)
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(VariableStatement, "Insert", New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param6, False, False)), MsgBoxStatement)
                End If
            Else
                Return Nothing
            End If
