<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Supprimer_Valeur_Registrer_Designer))> _
Public Class Supprimer_Valeur_Registrer
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Supprimer_Valeur_Registrer", GetType(Supprimer_Valeur_Registrer).Assembly)
        Using frm As New Supprimer_Valeur_Registrer_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("_computer.Registry." & Me.Param2), "OpenSubKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodePrimitiveExpression(True)), "DeleteValue", New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param3, True)))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.Registry." & Me.Param2), "OpenSubKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodePrimitiveExpression(True)), "DeleteValue", New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param3, True)))
                End If
            Else
                Return Nothing
            End If
