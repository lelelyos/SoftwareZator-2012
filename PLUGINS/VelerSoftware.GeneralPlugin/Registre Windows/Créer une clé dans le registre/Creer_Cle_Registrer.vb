<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Creer_Cle_Registrer_Designer))> _
Public Class Creer_Cle_Registrer
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Creer_Cle_Registrer", GetType(Creer_Cle_Registrer).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.creer_cle_registre
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Creer_Cle_Registrer", GetType(Creer_Cle_Registrer).Assembly)
        Using frm As New Creer_Cle_Registrer_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("_computer.Registry." & Me.Param2), "CreateSubKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param1, True)))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.Registry." & Me.Param2), "CreateSubKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param1, True)))
                End If
            Else
                Return Nothing
            End If
