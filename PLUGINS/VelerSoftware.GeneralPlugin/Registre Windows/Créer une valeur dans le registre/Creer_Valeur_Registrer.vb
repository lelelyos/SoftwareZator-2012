<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Creer_Valeur_Registrer_Designer))> _
Public Class Creer_Valeur_Registrer
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Creer_Valeur_Registrer", GetType(Creer_Valeur_Registrer).Assembly)
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Creer_Valeur_Registrer", GetType(Creer_Valeur_Registrer).Assembly)
        Using frm As New Creer_Valeur_Registrer_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                ...
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("_computer.Registry"), "SetValue"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(key, True)), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param3, True)), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param4, True)))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.Registry"), "SetValue"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(key, True)), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param3, True)), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param4, True)))
                End If
            Else
                Return Nothing
            End If
