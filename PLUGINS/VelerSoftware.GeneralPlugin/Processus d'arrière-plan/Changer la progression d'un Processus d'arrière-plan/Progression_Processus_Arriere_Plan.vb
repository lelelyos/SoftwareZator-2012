<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Progression_Processus_Arriere_Plan_Designer))> _
Public Class Progression_Processus_Arriere_Plan
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.progression_backgroundworker
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Progression_Processus_Arriere_Plan", GetType(Progression_Processus_Arriere_Plan).Assembly)
        Using frm As New Progression_Processus_Arriere_Plan_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1.StartsWith("Me.") Then
                        Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Param1.Substring(3)), "ReportProgress"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param5, False, False)), New CodeDom.CodeSnippetExpression(Me.Param3))
                    Else
                        Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "ReportProgress"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param5, False, False)), New CodeDom.CodeSnippetExpression(Me.Param3))
                    End If
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "ReportProgress"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param5, False, False)), New CodeDom.CodeSnippetExpression(Me.Param3))
                End If
