Public Class Convertir_Valeur_Propriete_Form
        ...
        With Me
            ...
            For Each act As VelerSoftware.Plugins3.Action In .Tools.GetActionsOfFuntion(.Tools.GetCurrentDocumentName)
                If TypeOf act Is VelerSoftware.GeneralPlugin.Declarer_Propriete Then
                    .Var1_ComboBox.Items.Add(act.Param1)
                End If
            Next
        ...
        If (Not sender Is Nothing) AndAlso (sender.Namespaces.Count > 0) Then
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodeCastExpression Then
                    ...
                    End Select
                    If TypeOf metho.Expression Is CodeDom.CodePropertyReferenceExpression Then
                        Me.Var1_ComboBox.Text = DirectCast(metho.Expression, CodeDom.CodePropertyReferenceExpression).PropertyName
                    End If
