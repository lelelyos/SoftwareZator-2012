Public Class Obtenir_Propriete_Propriete_Form
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Left Is CodeDom.CodeVariableReferenceExpression AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodePropertyReferenceExpression Then
                    ...
                    If TypeOf metho.TargetObject Is CodeDom.CodeCastExpression AndAlso TypeOf DirectCast(metho.TargetObject, CodeDom.CodeCastExpression).Expression Is CodeDom.CodePropertyReferenceExpression Then
                        Me.Var1_ComboBox.Text = DirectCast(DirectCast(metho.TargetObject, CodeDom.CodeCastExpression).Expression, CodeDom.CodePropertyReferenceExpression).PropertyName
