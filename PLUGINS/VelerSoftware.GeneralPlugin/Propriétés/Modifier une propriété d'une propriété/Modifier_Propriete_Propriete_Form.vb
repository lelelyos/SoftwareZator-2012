Public Class Modifier_Propriete_Propriete_Form
        ...
        With Me
            ...
            For Each act As VelerSoftware.Plugins3.Action In .Tools.GetActionsOfFuntion(.Tools.GetCurrentDocumentName)
                If TypeOf act Is VelerSoftware.GeneralPlugin.Declarer_Propriete Then
                    Me.Parametre_ComboBox.Items.Add(act.Param1)
                End If
            Next
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        Dim OperationStatement As New CodeDom.CodeAssignStatement(New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeCastExpression(New CodeDom.CodeTypeReference(Me.ActionTextBox1.Text), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeThisReferenceExpression, Me.Parametre_ComboBox.Text)), Me.ComboBox1.Text.Split("(")(0).Trim(" ")), New CodeDom.CodeSnippetExpression(Me.ValueEdit1.GetGeneratedCode()))
