Public Class Obtenir_Type_Propriete_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            For Each a As VelerSoftware.SZVB.Projet.Variable In .Tools.GetCurrentProjectVariableList
                ...
                End If
            Next
            For Each act As VelerSoftware.Plugins3.Action In .Tools.GetActionsOfFuntion(.Tools.GetCurrentDocumentName)
                If TypeOf act Is VelerSoftware.GeneralPlugin.Declarer_Propriete Then
                    Me.Var1_ComboBox.Items.Add(act.Param1)
                End If
            Next
    ...
    Private Sub FonctionForm_OnOKButtonClicked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnOKButtonClicked
        With Me
            If .Var1_ComboBox.Text = "" OrElse .Var2_ComboBox.Text = "" Then
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        Dim VariableStatement As New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeThisReferenceExpression, Me.Var1_ComboBox.Text)
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement Then
                    ...
                    If TypeOf metho.Left Is CodeDom.CodeVariableReferenceExpression AndAlso TypeOf metho.Right Is CodeDom.CodePropertyReferenceExpression AndAlso DirectCast(metho.Right, CodeDom.CodePropertyReferenceExpression).PropertyName = "FullName" Then
                        ...
                        Me.Var1_ComboBox.Text = TryCast(DirectCast(DirectCast(metho.Right, CodeDom.CodePropertyReferenceExpression).TargetObject, CodeDom.CodeMethodInvokeExpression).Method.TargetObject, CodeDom.CodePropertyReferenceExpression).PropertyName
                    End If
                End If
            Next
        End If
