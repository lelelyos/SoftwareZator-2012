<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Date_Texte_Designer))> _
Public Class Obtenir_Date_Texte
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Date_Texte", GetType(Obtenir_Date_Texte).Assembly)
        Using frm As New Obtenir_Date_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("Microsoft.VisualBasic.DateValue(" & Me.Tools.TransformKeyVariables(Me.Param2, True) & ")"))
            Else
                Return Nothing
            End If
        End If
