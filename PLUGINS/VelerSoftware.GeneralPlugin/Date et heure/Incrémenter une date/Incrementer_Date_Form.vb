Public Class Incrementer_Date_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            If Not .Param1 = Nothing Then
                .ValueEdit2.SetGeneratedCode(.Param1)
            End If
            If Not .Param2 = Nothing Then
                .ValueEdit2.SetStrictValue(.Param2, CInt(.Param3))
            End If

            If Not .Param4 = Nothing Then
                .Boutons_ComboBox.SelectedIndex = CInt(.Param4)
            End If

            If Not .Param5 = Nothing Then
                .ActionTextBox1.Text = .Param5
            End If

            If Not .Param6 = Nothing Then
                If Not .ComboBox1.FindString(.Param6) = -1 Then
                    .ComboBox1.Text = .ComboBox1.Items(.ComboBox1.FindString(.Param6))
                End If
            End If
        End With
    End Sub
    ...
    Private Sub FonctionForm_OnOKButtonClicked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnOKButtonClicked
        With Me
            ...
            .Param1 = .ValueEdit2.GetGeneratedCode()
            .Param2 = .ValueEdit2.GetStrictValue()
            .Param3 = CInt(.ValueEdit2.Editor)

            .Param4 = .Boutons_ComboBox.SelectedIndex
            .Param5 = .ActionTextBox1.Text
            .Param6 = .ComboBox1.Text
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        OperationStatement = New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Microsoft.VisualBasic"), "DateAdd"), New CodeDom.CodeSnippetExpression(comparer), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.ActionTextBox1.Text, False, False)), New CodeDom.CodeSnippetExpression(Me.ValueEdit2.GetGeneratedCode))
        ...
        If (Not sender Is Nothing) AndAlso (sender.Namespaces.Count > 0) Then
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Left Is CodeDom.CodeVariableReferenceExpression AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodeMethodInvokeExpression Then
                    ...
                    If OperationStatement.Method.MethodName = "DateAdd" AndAlso OperationStatement.Parameters.Count > 0 AndAlso TypeOf OperationStatement.Parameters(0) Is CodeDom.CodePropertyReferenceExpression Then
                        If TypeOf OperationStatement.Parameters(1) Is CodeDom.CodePrimitiveExpression Then
                            Me.ActionTextBox1.Text = DirectCast(OperationStatement.Parameters(1), CodeDom.CodePrimitiveExpression).Value
                        End If
