<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Information_Dates_Designer))> _
Public Class Obtenir_Information_Dates
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Information_Dates", GetType(Obtenir_Information_Dates).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.obtenir_information_dates
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Information_Dates", GetType(Obtenir_Information_Dates).Assembly)
        Using frm As New Obtenir_Information_Dates_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param8), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Microsoft.VisualBasic"), "DatePart"), New CodeDom.CodeSnippetExpression(comparer), New CodeDom.CodeSnippetExpression(Me.Param4)))
            Else
                Return Nothing
            End If
        End If
