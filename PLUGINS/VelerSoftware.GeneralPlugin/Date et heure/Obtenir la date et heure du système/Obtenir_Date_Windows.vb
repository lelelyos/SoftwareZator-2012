<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Date_Windows_Designer))> _
Public Class Obtenir_Date_Windows
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.obtenir_date_windows
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Date_Windows", GetType(Obtenir_Date_Windows).Assembly)
        Using frm As New Obtenir_Date_Windows_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("System.DateTime.Now"))
            Else
                Return Nothing
            End If
        End If
