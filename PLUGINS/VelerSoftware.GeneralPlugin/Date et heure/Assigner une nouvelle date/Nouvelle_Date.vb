<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Nouvelle_Date_Designer))> _
Public Class Nouvelle_Date
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Nouvelle_Date", GetType(Nouvelle_Date).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.nouvelle_date
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Nouvelle_Date", GetType(Nouvelle_Date).Assembly)
        Using frm As New Nouvelle_Date_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("New System.DateTime(" & _
                                                                                                                                                                           Me.Tools.TransformKeyVariables(Me.Param2, False, False) & ", " & _
                                                                                                                                                                           Me.Tools.TransformKeyVariables(Me.Param3, False, False) & ", " & _
                                                                                                                                                                           Me.Tools.TransformKeyVariables(Me.Param4, False, False) & ", " & _
                                                                                                                                                                           Me.Tools.TransformKeyVariables(Me.Param5, False, False) & ", " & _
                                                                                                                                                                           Me.Tools.TransformKeyVariables(Me.Param6, False, False) & ", " & _
                                                                                                                                                                           Me.Tools.TransformKeyVariables(Me.Param7, False, False) & ")"))
            Else
                Return Nothing
            End If
        End If
