<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Propriete_Donnee_Serialisable_Designer))> _
Public Class Obtenir_Propriete_Donnee_Serialisable
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.obtenir_propriete_donnee_serialisable
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Propriete_Donnee_Serialisable", GetType(Obtenir_Propriete_Donnee_Serialisable).Assembly)
        Using frm As New Obtenir_Propriete_Donnee_Serialisable_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param4), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeCastExpression(New CodeDom.CodeTypeReference("VelerSoftware_GeneralPlugin_Types." & Me.Param2.Split("(")(0).Trim(" ")), New CodeDom.CodeVariableReferenceExpression(Me.Param1)), Me.Param3))
            Else
                Return Nothing
            End If
        End If
