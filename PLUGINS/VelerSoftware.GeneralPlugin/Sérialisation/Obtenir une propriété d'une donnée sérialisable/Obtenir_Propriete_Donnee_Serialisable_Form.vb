Public Class Obtenir_Propriete_Donnee_Serialisable_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            If Not .Param4 = Nothing Then
                If Not .ComboBox4.FindString(.Param4) = -1 Then
                    .ComboBox4.Text = .ComboBox4.Items(.ComboBox4.FindString(.Param4))
                End If
            End If
    ...
    Private Sub FonctionForm_OnOKButtonClicked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnOKButtonClicked
        With Me
            If .ComboBox2.Text = "" OrElse .ComboBox1.Text = "" OrElse .ComboBox3.Text = "" OrElse .ComboBox4.Text = "" Then
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        If Me.ComboBox2.Text = "" OrElse Me.ComboBox1.Text = "" OrElse Me.ComboBox3.Text = "" OrElse Me.ComboBox4.Text = "" Then
            MsgBox(RM.GetString("Aucun_Nom"), MsgBoxStyle.Exclamation)
            Exit Sub
        End If
        ...
        CodeDom.Compiler.CodeDomProvider.CreateProvider("VB").GenerateCodeFromStatement(New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.ComboBox4.Text), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeCastExpression(New CodeDom.CodeTypeReference("VelerSoftware_GeneralPlugin_Types." & Me.ComboBox1.Text.Split("(")(0).Trim(" ")), New CodeDom.CodeVariableReferenceExpression(Me.ComboBox2.Text)), Me.ComboBox3.Text)), sourceWriter, New CodeDom.Compiler.CodeGeneratorOptions())
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement Then
                    If TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Left Is CodeDom.CodeVariableReferenceExpression Then
                        Me.ComboBox4.Text = DirectCast(DirectCast(sta, CodeDom.CodeAssignStatement).Left, CodeDom.CodeVariableReferenceExpression).VariableName
                    End If
