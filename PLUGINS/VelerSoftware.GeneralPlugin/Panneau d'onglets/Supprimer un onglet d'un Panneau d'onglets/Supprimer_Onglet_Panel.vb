<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Supprimer_Onglet_Panel_Designer))> _
Public Class Supprimer_Onglet_Panel
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.supprimer_onglet_tabcontrol
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Supprimer_Onglet_Panel", GetType(Supprimer_Onglet_Panel).Assembly)
        Using frm As New Supprimer_Onglet_Panel_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1.StartsWith("Me.") Then
                        Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Param1.Substring(3) & ".TabPages"), "RemoveByKey"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param2, True)))
                    Else
                        Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1 & ".TabPages"), "RemoveByKey"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param2, True)))
                    End If
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1 & ".TabPages"), "RemoveByKey"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param2, True)))
                End If
