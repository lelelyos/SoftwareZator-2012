Public Class Supprimer_Onglet_Panel_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Boutons_ComboBox.Text.Substring(3) & ".TabPages"), "RemoveByKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Annee_ActionTextBox1.Text, True)))
        Else
            OperationStatement = New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Boutons_ComboBox.Text & ".TabPages"), "RemoveByKey"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Annee_ActionTextBox1.Text, True)))
        End If
