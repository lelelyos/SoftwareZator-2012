Public Class Obtenir_Tous_Noeuds_TreeView_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of Object)(System.Linq.Enumerable.Cast(Of Object)(" & Me.Boutons_ComboBox.Text & ".Nodes))")
        Else
            OperationStatement = New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of Object)(System.Linq.Enumerable.Cast(Of Object)(Variables." & Me.Boutons_ComboBox.Text & ".Nodes))")
        End If
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Left Is CodeDom.CodeVariableReferenceExpression AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodeObjectCreateExpression Then
                    ...
                    If DirectCast(DirectCast(sta, CodeDom.CodeAssignStatement).Right, CodeDom.CodeObjectCreateExpression).Parameters.Count = 1 AndAlso TypeOf DirectCast(DirectCast(sta, CodeDom.CodeAssignStatement).Right, CodeDom.CodeObjectCreateExpression).Parameters(0) Is CodeDom.CodeMethodInvokeExpression Then
                        ...
                        If metho.Method.MethodName = "Cast" AndAlso metho.Parameters.Count = 1 AndAlso TypeOf metho.Parameters(0) Is CodeDom.CodePropertyReferenceExpression AndAlso DirectCast(metho.Parameters(0), CodeDom.CodePropertyReferenceExpression).PropertyName = "Nodes" Then
