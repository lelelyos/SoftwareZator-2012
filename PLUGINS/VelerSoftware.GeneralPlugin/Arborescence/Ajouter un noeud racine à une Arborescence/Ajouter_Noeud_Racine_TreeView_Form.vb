Public Class Ajouter_Noeud_Racine_TreeView_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            .Index_ActionTextBox1.Text = ""
            .Nom_ActionTextBox.Text = ""
            .Texte_ActionTextBox2.Text = ""
            .Img_ActionTextBox4.Text = ""
            ...
            For Each aaa As VelerSoftware.Plugins3.Windows.Core.Object In .Tools.GetCurrentProjectWindowsControls
                If aaa.ObjectType = GetType(CodeDom.CodeMemberField) AndAlso (DirectCast(aaa.Object, CodeDom.CodeMemberField).Type.BaseType = "System.Windows.Forms.TreeView" OrElse DirectCast(aaa.Object, CodeDom.CodeMemberField).Type.BaseType = "ComponentFactory.Krypton.Tookit.KryptonTreeView") Then
    ...
    Private Sub FonctionForm_OnOKButtonClicked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnOKButtonClicked
        With Me
            If .Boutons_ComboBox.Text = "" OrElse .Nom_ActionTextBox.Text = "" OrElse .Texte_ActionTextBox2.Text = "" Then
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        If Me.Boutons_ComboBox.Text = "" OrElse Me.Nom_ActionTextBox.Text = "" OrElse Me.Texte_ActionTextBox2.Text = "" Then
            MsgBox(RM.GetString("Formulaire_Incomplet"), MsgBoxStyle.Exclamation)
            Exit Sub
        End If
        ...
        If Me.RadioButton1.Checked Then
            If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
                OperationStatement = New CodeDom.CodeSnippetExpression(Me.Boutons_ComboBox.Text & ".Nodes.Add(" & Me.Tools.TransformKeyVariables(Me.Nom_ActionTextBox.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Texte_ActionTextBox2.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ")")
            Else
                OperationStatement = New CodeDom.CodeSnippetExpression("Variables." & Me.Boutons_ComboBox.Text & ".Items.Add(" & Me.Tools.TransformKeyVariables(Me.Nom_ActionTextBox.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Texte_ActionTextBox2.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ")")
            End If
        Else
            If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
                OperationStatement = New CodeDom.CodeSnippetExpression(Me.Boutons_ComboBox.Text & ".Nodes.Insert(" & Me.Tools.TransformKeyVariables(Me.Index_ActionTextBox1.Text, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Nom_ActionTextBox.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Texte_ActionTextBox2.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ")")
            Else
                OperationStatement = New CodeDom.CodeSnippetExpression("Variables." & Me.Boutons_ComboBox.Text & ".Nodes.Insert(" & Me.Tools.TransformKeyVariables(Me.Index_ActionTextBox1.Text, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Nom_ActionTextBox.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Texte_ActionTextBox2.Text, True) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ", " & Me.Tools.TransformKeyVariables(Me.Img_ActionTextBox4.Text, False, False) & ")")
            End If
        End If
                ...
                If TypeOf sta Is CodeDom.CodeExpressionStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeExpressionStatement).Expression Is CodeDom.CodeMethodInvokeExpression Then
                    ...
                    If metho.Method.MethodName = "Add" Then
                        ...
                        If metho.Parameters.Count > 0 AndAlso TypeOf metho.Parameters(0) Is CodeDom.CodePrimitiveExpression Then
                            Me.Nom_ActionTextBox.Text = CInt(DirectCast(metho.Parameters(0), CodeDom.CodePrimitiveExpression).Value)
                        End If
                        If metho.Parameters.Count > 1 AndAlso TypeOf metho.Parameters(1) Is CodeDom.CodePrimitiveExpression Then
                            Me.Texte_ActionTextBox2.Text = CInt(DirectCast(metho.Parameters(1), CodeDom.CodePrimitiveExpression).Value)
                        End If
                        If metho.Parameters.Count > 2 AndAlso TypeOf metho.Parameters(2) Is CodeDom.CodePrimitiveExpression AndAlso Microsoft.VisualBasic.IsNumeric(DirectCast(metho.Parameters(3), CodeDom.CodePrimitiveExpression).Value) Then
                            Me.Img_ActionTextBox4.Text = CInt(DirectCast(metho.Parameters(2), CodeDom.CodePrimitiveExpression).Value)
                        End If
                    ElseIf metho.Method.MethodName = "Insert" Then
                        Me.RadioButton2.Checked = True
                        If metho.Parameters.Count > 0 AndAlso TypeOf metho.Parameters(0) Is CodeDom.CodePrimitiveExpression AndAlso Microsoft.VisualBasic.IsNumeric(DirectCast(metho.Parameters(0), CodeDom.CodePrimitiveExpression).Value) Then
                            Me.Index_ActionTextBox1.Text = CInt(DirectCast(metho.Parameters(0), CodeDom.CodePrimitiveExpression).Value)
                        End If
                        If metho.Parameters.Count > 1 AndAlso TypeOf metho.Parameters(1) Is CodeDom.CodePrimitiveExpression Then
                            Me.Nom_ActionTextBox.Text = CInt(DirectCast(metho.Parameters(1), CodeDom.CodePrimitiveExpression).Value)
                        End If
                        If metho.Parameters.Count > 2 AndAlso TypeOf metho.Parameters(2) Is CodeDom.CodePrimitiveExpression Then
                            Me.Texte_ActionTextBox2.Text = CInt(DirectCast(metho.Parameters(2), CodeDom.CodePrimitiveExpression).Value)
                        End If
                        If metho.Parameters.Count > 3 AndAlso TypeOf metho.Parameters(3) Is CodeDom.CodePrimitiveExpression AndAlso Microsoft.VisualBasic.IsNumeric(DirectCast(metho.Parameters(3), CodeDom.CodePrimitiveExpression).Value) Then
                            Me.Img_ActionTextBox4.Text = CInt(DirectCast(metho.Parameters(3), CodeDom.CodePrimitiveExpression).Value)
                        End If
                    End If
