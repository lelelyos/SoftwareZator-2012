Public Class Couleur_Texte_Console_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        CodeDom.Compiler.CodeDomProvider.CreateProvider("VB").GenerateCodeFromStatement(New CodeDom.CodeAssignStatement(New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeTypeReferenceExpression("System.Console"), "ForegroundColor"), New CodeDom.CodeSnippetExpression(Me.ComboBox1.SelectedIndex)), sourceWriter, New CodeDom.Compiler.CodeGeneratorOptions())
        ...
        If (Not sender Is Nothing) AndAlso (sender.Namespaces.Count > 0) Then
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Left Is CodeDom.CodePropertyReferenceExpression Then
                    ...
                    If metho.PropertyName = "ForegroundColor" AndAlso TypeOf metho.TargetObject Is CodeDom.CodeTypeReferenceExpression AndAlso DirectCast(metho.TargetObject, CodeDom.CodeTypeReferenceExpression).Type.BaseType = "System.Console" Then
