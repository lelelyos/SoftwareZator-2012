<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Attendre_Appui_Touche_Continuer_Console_Designer))> _
Public Class Attendre_Appui_Touche_Continuer_Console
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Pause_Console
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Attendre_Appui_Touche_Continuer_Console", GetType(Attendre_Appui_Touche_Continuer_Console).Assembly)
        Using frm As New Attendre_Appui_Touche_Continuer_Console_Form
            frm.Tools = Me.Tools
            frm.Param1 = "Appuyez sur une touche pour continuer."
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                If Me.Param1 = Nothing Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("System.Console"), "ReadKey", New CodeDom.CodeSnippetExpression("False"))
                Else
                    Return New CodeDom.CodeSnippetExpression("System.Console.WriteLine(" & Me.Tools.TransformKeyVariables(Me.Param1, True) & ") : System.Console.ReadKey(False)")
                End If
            Else
                Return Nothing
            End If
