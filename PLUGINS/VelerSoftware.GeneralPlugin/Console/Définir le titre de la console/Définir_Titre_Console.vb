<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Definir_Titre_Console_Designer))> _
Public Class Definir_Titre_Console
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Definir_Titre_Console", GetType(Definir_Titre_Console).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.Definir_Titre_Console
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Definir_Titre_Console", GetType(Definir_Titre_Console).Assembly)
        Using frm As New Definir_Titre_Console_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeTypeReferenceExpression("System.Console"), "Title"), New CodeDom.CodeSnippetExpression(Me.Tools.TransformKeyVariables(Me.Param1, True)))
            Else
                Return Nothing
            End If
        End If
