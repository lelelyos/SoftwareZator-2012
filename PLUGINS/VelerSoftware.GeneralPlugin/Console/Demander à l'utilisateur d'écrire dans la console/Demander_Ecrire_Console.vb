<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Demander_Ecrire_Console_Designer))> _
Public Class Demander_Ecrire_Console
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Demander_Utilisateur_Ecrire_Console
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Demander_Ecrire_Console", GetType(Demander_Ecrire_Console).Assembly)
        Using frm As New Demander_Ecrire_Console_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("System.Console"), "ReadLine")))
            Else
                Return Nothing
            End If
        End If
