<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Decrypter_Fichier_Designer))> _
Public Class Decrypter_Fichier
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Decrypter_Fichier", GetType(Decrypter_Fichier).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.Decrypter_Fichier
            ...
            .ClassCode = "VelerSoftware.GeneralPlugin.Decrypter_Fichier.vb"
        End With
    End Sub
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Decrypter_Fichier", GetType(Decrypter_Fichier).Assembly)
        Using frm As New Decrypter_Fichier_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_GeneralPlugin"), "EncryptOrDecryptFile", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True)), New CodeDom.CodeSnippetExpression("DirectCast(VelerSoftware_GeneralPlugin.CreateKey(" & Tools.TransformKeyVariables(Me.Param3, True) & "), Byte())"), New CodeDom.CodeSnippetExpression("DirectCast(VelerSoftware_GeneralPlugin.CreateIV(" & Tools.TransformKeyVariables(Me.Param3, True) & "), Byte())"), New CodeDom.CodeSnippetExpression("VelerSoftware_GeneralPlugin.CryptoAction.ActionDecrypt"))
            Else
                Return Nothing
            End If
        End If
            ...
            If ErrorToResole.ErrorNumber = "BC30452" Then ' Une variable tableau a été utilisé dans le titre ou message
                ...
                For Each var As VelerSoftware.SZVB.Projet.Variable In Me.Tools.GetCurrentProjectVariableList
                    If var.Array Then
                        ...
                        If Not Me.Param3 = Nothing Then Me.Param3 = Me.Param2.Replace("%(VARIABLE=" & var.Name & ")%", Nothing)
                    End If
                Next
