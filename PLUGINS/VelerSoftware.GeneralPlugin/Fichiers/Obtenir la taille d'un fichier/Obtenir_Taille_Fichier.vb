<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Taille_Fichier_Designer))> _
Public Class Obtenir_Taille_Fichier
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Taille_Fichier", GetType(Obtenir_Taille_Fichier).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.Obtenir_Taille_Fichier
            ...
            .ClassCode = "VelerSoftware.GeneralPlugin.Obtenir_Taille_Fichier.vb"
        End With
    End Sub
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Taille_Fichier", GetType(Obtenir_Taille_Fichier).Assembly)
        Using frm As New Obtenir_Taille_Fichier_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_GeneralPlugin"), "GetFileLen", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodePrimitiveExpression(Me.Param3), New CodeDom.CodePrimitiveExpression(Me.Param4), New CodeDom.CodePrimitiveExpression(Me.Param5)))
            Else
                Return Nothing
            End If
        End If
