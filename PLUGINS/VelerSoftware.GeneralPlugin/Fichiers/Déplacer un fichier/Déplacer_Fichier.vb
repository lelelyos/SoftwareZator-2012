<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Déplacer_Fichier_Designer))> _
Public Class Déplacer_Fichier
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Deplacer_Fichier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Déplacer_Fichier", GetType(Déplacer_Fichier).Assembly)
        Using frm As New Déplacer_Fichier_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("_computer.FileSystem"), "MoveFile", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True)), New CodeDom.CodeSnippetExpression(Me.Param3))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.FileSystem"), "MoveFile", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True)), New CodeDom.CodeSnippetExpression(Me.Param3))
                End If
            Else
                Return Nothing
            End If
