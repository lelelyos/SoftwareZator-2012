<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Information_Fichier_Designer))> _
Public Class Obtenir_Information_Fichier
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Obtenir_Information_Fichier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Information_Fichier", GetType(Obtenir_Information_Fichier).Assembly)
        Using frm As New Obtenir_Information_Fichier_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("System.IO.File"), Me.Param2, New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True))), Me.Param3)
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param4), MsgBoxStatement)
             Else
                Return Nothing
            End If
        End If
