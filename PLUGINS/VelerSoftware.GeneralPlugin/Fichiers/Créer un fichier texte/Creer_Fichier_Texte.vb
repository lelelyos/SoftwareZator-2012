<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Creer_Fichier_Texte_Designer))> _
Public Class Creer_Fichier_Texte
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.creer_fichier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Creer_Fichier_Texte", GetType(Creer_Fichier_Texte).Assembly)
        Using frm As New Creer_Fichier_Texte_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("_computer.FileSystem"), "WriteAllText", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True)), New CodeDom.CodeSnippetExpression(Me.Param3), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeTypeReferenceExpression("System.Text.Encoding"), Me.Param4))
                Else
