<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Creer_Dossier_Designer))> _
Public Class Creer_Dossier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Creer_Dossier", GetType(Creer_Dossier).Assembly)
        Using frm As New Creer_Dossier_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("_computer.FileSystem"), "CreateDirectory", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.FileSystem"), "CreateDirectory", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)))
                End If
            Else
                Return Nothing
            End If
