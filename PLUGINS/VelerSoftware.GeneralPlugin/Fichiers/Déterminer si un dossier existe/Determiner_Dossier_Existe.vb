<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Determiner_Dossier_Existe_Designer))> _
Public Class Determiner_Dossier_Existe
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Determiner_Dossier_Existe", GetType(Determiner_Dossier_Existe).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.Determiner_Dossier_Existe
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Determiner_Dossier_Existe", GetType(Determiner_Dossier_Existe).Assembly)
        Using frm As New Determiner_Dossier_Existe_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("_computer.FileSystem"), "DirectoryExists", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True))))
                Else
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.FileSystem"), "DirectoryExists", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True))))
                End If
            Else
                Return Nothing
            End If
