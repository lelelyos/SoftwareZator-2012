<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Extension_Fichier_Designer))> _
Public Class Obtenir_Extension_Fichier
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Obtenir_Extension_Fichier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Extension_Fichier", GetType(Obtenir_Extension_Fichier).Assembly)
        Using frm As New Obtenir_Extension_Fichier_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Dim MsgBoxStatement As New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("_computer.FileSystem"), "GetFileInfo", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True))), "Extension")
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), MsgBoxStatement)
                Else
                    Dim MsgBoxStatement As New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.FileSystem"), "GetFileInfo", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True))), "Extension")
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), MsgBoxStatement)
                End If
            Else
                Return Nothing
