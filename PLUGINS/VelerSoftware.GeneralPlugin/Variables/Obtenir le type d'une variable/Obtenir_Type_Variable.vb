<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Type_Variable_Designer))> _
Public Class Obtenir_Type_Variable
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Type_Variable", GetType(Obtenir_Type_Variable).Assembly)
        Using frm As New Obtenir_Type_Variable_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim VariableStatement2 As New CodeDom.CodeVariableReferenceExpression(Me.Param1)
