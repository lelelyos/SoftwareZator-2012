<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Convertir_Valeur_Variable_Designer))> _
Public Class Convertir_Valeur_Variable
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Convertir_Valeur_Variable", GetType(Convertir_Valeur_Variable).Assembly)
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Convertir_Valeur_Variable", GetType(Convertir_Valeur_Variable).Assembly)
        Using frm As New Convertir_Valeur_Variable_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param3), New CodeDom.CodeCastExpression(New CodeDom.CodeTypeReference(Me.Param2), New CodeDom.CodeVariableReferenceExpression(Me.Param1)))
            Else
                Return Nothing
            End If
         End If
