Public Class Modifier_Propriete_Variable_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            For Each a As VelerSoftware.SZVB.Projet.Variable In .Tools.GetCurrentProjectVariableList
                If Not a.Array Then .Parametre_ComboBox.Items.Add(a.Name)
            Next
    ...
    Private Sub FonctionForm_OnOKButtonClicked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnOKButtonClicked
        With Me
            If .Parametre_ComboBox.Text = Nothing OrElse .ComboBox1.Text = Nothing Then
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Parametre_ComboBox.Text = Nothing OrElse Me.ComboBox1.Text = Nothing Then
            MsgBox(RM.GetString("Formulaire_Incomplet"), MsgBoxStyle.Exclamation)
            Exit Sub
        End If
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Left Is CodeDom.CodePropertyReferenceExpression Then
                    ...
                    If TypeOf metho.TargetObject Is CodeDom.CodeCastExpression AndAlso TypeOf DirectCast(metho.TargetObject, CodeDom.CodeCastExpression).Expression Is CodeDom.CodeVariableReferenceExpression Then
                        Me.Parametre_ComboBox.Text = DirectCast(DirectCast(metho.TargetObject, CodeDom.CodeCastExpression).Expression, CodeDom.CodeVariableReferenceExpression).VariableName
