<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_Propriete_Tableau_Variable_Designer))> _
Public Class Obtenir_Propriete_Tableau_Variable
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.obtenir_propriete_valeur
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_Propriete_Tableau_Variable", GetType(Obtenir_Propriete_Tableau_Variable).Assembly)
        Using frm As New Obtenir_Propriete_Tableau_Variable_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim VariableStatement2 As New CodeDom.CodeVariableReferenceExpression(Me.Param4)
                If Me.Param3.EndsWith("[])") Then
                    Return New CodeDom.CodeAssignStatement(VariableStatement2, New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of Object)(System.Linq.Enumerable.Cast(Of Object)(System.Linq.Enumerable.AsEnumerable(DirectCast(" & Me.Param1 & ", " & Me.Param2 & ")" & "." & Me.Param3.Split("(")(0).Trim(" ") & ")))"))
                Else
                    Return New CodeDom.CodeAssignStatement(VariableStatement2, New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of Object)(System.Linq.Enumerable.Cast(Of Object)(DirectCast(" & Me.Param1 & ", " & Me.Param2 & ")" & "." & Me.Param3.Split("(")(0).Trim(" ") & "))"))
                End If
            Else
                Return Nothing
            End If
