<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Derterminer_Connecter_Internet_Designer))> _
Public Class Derterminer_Connecter_Internet
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Determiner_Connecter_Internet
            ...
            .ClassCode = "VelerSoftware.GeneralPlugin.Determiner_Connecter_Internet.vb"
        End With
    End Sub
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Derterminer_Connecter_Internet", GetType(Derterminer_Connecter_Internet).Assembly)
        Using frm As New Derterminer_Connecter_Internet_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_GeneralPlugin"), "IsConnected"))
            Else
                Return Nothing
            End If
        End If
