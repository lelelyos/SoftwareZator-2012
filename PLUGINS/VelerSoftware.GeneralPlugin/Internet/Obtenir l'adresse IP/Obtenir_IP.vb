<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Obtenir_IP_Designer))> _
Public Class Obtenir_IP
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Obtenir_IP
            ...
            .ClassCode = "VelerSoftware.GeneralPlugin.Obtenir_IP.vb"
        End With
    End Sub
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Obtenir_IP", GetType(Obtenir_IP).Assembly)
        Using frm As New Obtenir_IP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeMethodReferenceExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_GeneralPlugin"), "GetIp"))
            Else
                Return Nothing
            End If
        End If
