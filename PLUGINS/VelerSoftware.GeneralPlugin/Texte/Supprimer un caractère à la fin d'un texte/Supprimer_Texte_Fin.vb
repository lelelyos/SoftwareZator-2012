<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Supprimer_Texte_Fin_Designer))> _
Public Class Supprimer_Texte_Fin
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Supprimer_Texte_Fin", GetType(Supprimer_Texte_Fin).Assembly)
        Using frm As New Supprimer_Texte_Fin_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param2, True) & ").TrimEnd(" & Tools.TransformKeyVariables(Me.Param3, True) & ")")
