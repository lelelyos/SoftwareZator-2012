<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Mettre_Minuscule_Texte_Designer))> _
Public Class Mettre_Minuscule_Texte
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.text_upper
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Mettre_Minuscule_Texte", GetType(Mettre_Minuscule_Texte).Assembly)
        Using frm As New Mettre_Minuscule_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param2, True) & ").ToLower()")
