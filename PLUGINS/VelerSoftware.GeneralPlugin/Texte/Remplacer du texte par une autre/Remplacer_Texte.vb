<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Remplacer_Texte_Designer))> _
Public Class Remplacer_Texte
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.texte_replace
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Remplacer_Texte", GetType(Remplacer_Texte).Assembly)
        Using frm As New Remplacer_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param3, True) & ").Replace(" & Tools.TransformKeyVariables(Me.Param2, True) & ", " & Tools.TransformKeyVariables(Me.Param4, True) & ")")
