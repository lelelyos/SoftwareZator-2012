<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Commence_Texte_Designer))> _
Public Class Commence_Texte
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.text_search
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Commence_Texte", GetType(Commence_Texte).Assembly)
        Using frm As New Commence_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param3, True) & ").StartsWith(" & Tools.TransformKeyVariables(Me.Param2, True) & ")")
