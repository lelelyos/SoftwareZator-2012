<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Finit_Texte_Designer))> _
Public Class Finit_Texte
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Finit_Texte", GetType(Finit_Texte).Assembly)
        Using frm As New Finit_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param3, True) & ").EndsWith(" & Tools.TransformKeyVariables(Me.Param2, True) & ")")
