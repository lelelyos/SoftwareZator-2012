<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Supprimer_Texte_Debut_Designer))> _
Public Class Supprimer_Texte_Debut
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.textremoveSmall
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Supprimer_Texte_Debut", GetType(Supprimer_Texte_Debut).Assembly)
        Using frm As New Supprimer_Texte_Debut_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param2, True) & ").TrimStart(" & Tools.TransformKeyVariables(Me.Param3, True) & ")")
