<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Decouper_Texte_Designer))> _
Public Class Decouper_Texte
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Decouper_Texte", GetType(Decouper_Texte).Assembly)
        Using frm As New Decouper_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of Object)(System.Linq.Enumerable.Cast(Of Object)(CStr(" & Tools.TransformKeyVariables(Me.Param2, True) & ").Split(" & Tools.TransformKeyVariables(Me.Param3, True) & ")))")
