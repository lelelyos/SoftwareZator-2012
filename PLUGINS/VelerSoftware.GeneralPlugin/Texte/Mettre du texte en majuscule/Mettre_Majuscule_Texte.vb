<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Mettre_Majuscule_Texte_Designer))> _
Public Class Mettre_Majuscule_Texte
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.text_lower
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Mettre_Majuscule_Texte", GetType(Mettre_Majuscule_Texte).Assembly)
        Using frm As New Mettre_Majuscule_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param2, True) & ").ToUpper")
