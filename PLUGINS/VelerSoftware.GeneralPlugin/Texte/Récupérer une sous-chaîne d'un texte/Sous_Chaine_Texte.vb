<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Sous_Chaine_Texte_Designer))> _
Public Class Sous_Chaine_Texte
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.text_split
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Sous_Chaine_Texte", GetType(Sous_Chaine_Texte).Assembly)
        Using frm As New Sous_Chaine_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                If Me.Param4 = "" Then
                    MsgBoxStatement = New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param2, True) & ").SubString(" & Tools.TransformKeyVariables(Me.Param3, False, False) & ")")
                Else
                    MsgBoxStatement = New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param2, True) & ").SubString(" & Tools.TransformKeyVariables(Me.Param3, False, False) & ", " & Tools.TransformKeyVariables(Me.Param4, False, False) & ")")
                End If
