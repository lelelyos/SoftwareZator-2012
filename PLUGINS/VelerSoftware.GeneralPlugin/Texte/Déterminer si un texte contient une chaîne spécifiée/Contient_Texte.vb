<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Contient_Texte_Designer))> _
Public Class Contient_Texte
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Contient_Texte", GetType(Contient_Texte).Assembly)
        Using frm As New Contient_Texte_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                ...
                Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Param3, True) & ").Contains(" & Tools.TransformKeyVariables(Me.Param2, True) & ")")
