Public Class Contient_Texte_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        Dim MsgBoxStatement As New CodeDom.CodeSnippetExpression("CStr(" & Tools.TransformKeyVariables(Me.Titre_ActionTextBox.Text, True) & ").Contains(" & Tools.TransformKeyVariables(Me.Texte_Message_ActionTextBox.Text, True) & ")")
