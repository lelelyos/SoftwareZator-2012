<System.ComponentModel.Designer(GetType(VelerSoftware.GeneralPlugin.Jouer_Son_Designer))> _
Public Class Jouer_Son
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.jouer_un_son
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.GeneralPlugin.Jouer_Son", GetType(Jouer_Son).Assembly)
        Using frm As New Jouer_Son_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Tools.GetCurrentProjectType = SZVB.Projet.Projet.Types.ApplicationWindows Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("_computer.Audio"), "Play", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodeSnippetExpression("Microsoft.VisualBasic.AudioPlayMode." & Param2))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("My.Computer.Audio"), "Play", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param1, True)), New CodeDom.CodeSnippetExpression("Microsoft.VisualBasic.AudioPlayMode." & Param2))
                End If
            Else
                Return Nothing
            End If
