Public Class Obtenir_Propriete_Contrôle_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Var1_ComboBox.Text.StartsWith("Me ") Then
            OperationStatement = New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Var2_ComboBox.Text), New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.ComboBox1.Text.Split(" ")(0)))
        ElseIf Me.Var1_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Var2_ComboBox.Text), New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Var1_ComboBox.Text.Substring(3).Split(" ")(0) & "." & Me.ComboBox1.Text.Split(" ")(0)))
        Else
            OperationStatement = New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Var2_ComboBox.Text), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeVariableReferenceExpression("Variables." & Me.Var1_ComboBox.Text.Split("(")(0).Trim(" ")), Me.ComboBox1.Text.Split(" ")(0)))
        End If
