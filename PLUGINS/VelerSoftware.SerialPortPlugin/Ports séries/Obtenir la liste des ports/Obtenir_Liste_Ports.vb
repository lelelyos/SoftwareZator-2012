<System.ComponentModel.Designer(GetType(VelerSoftware.SerialPortPlugin.Obtenir_Liste_Ports_Designer))> _
Public Class Obtenir_Liste_Ports
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.serialport
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SerialPortPlugin.Obtenir_Liste_Ports", GetType(Obtenir_Liste_Ports).Assembly)
        Using frm As New Obtenir_Liste_Ports_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("New System.Collections.Generic.List(Of Object)(System.Linq.Enumerable.Cast(Of Object)(System.Linq.Enumerable.AsEnumerable(System.IO.Ports.SerialPort.GetPortNames())))"))
            Else
                Return Nothing
            End If
        End If
