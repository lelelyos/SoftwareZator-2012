<System.ComponentModel.Designer(GetType(VelerSoftware.SerialPortPlugin.Déterminer_Port_Connecte_Designer))> _
Public Class Déterminer_Port_Connecte
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SerialPortPlugin.Déterminer_Port_Connecte", GetType(Déterminer_Port_Connecte).Assembly)
        Using frm As New Déterminer_Port_Connecte_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1.StartsWith("Me.") Then
                        Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Param1.Substring(3)), "IsOpen"))
                    Else
                        Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "IsOpen"))
                    End If
                Else
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "IsOpen"))
                End If
