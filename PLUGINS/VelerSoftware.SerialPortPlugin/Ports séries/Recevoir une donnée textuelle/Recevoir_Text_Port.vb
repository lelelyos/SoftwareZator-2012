<System.ComponentModel.Designer(GetType(VelerSoftware.SerialPortPlugin.Recevoir_Text_Port_Designer))> _
Public Class Recevoir_Text_Port
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SerialPortPlugin.Recevoir_Text_Port", GetType(Recevoir_Text_Port).Assembly)
        Using frm As New Recevoir_Text_Port_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1.StartsWith("Me.") Then
                        Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Param1.Substring(3)), "ReadExisting"))
                    Else
                        Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "ReadExisting"))
                    End If
                Else
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("Variables." & Me.Param1), "ReadExisting"))
                End If
