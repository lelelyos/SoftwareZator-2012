<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Requete_FTP_Designer))> _
Public Class Requete_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Requete_FTP", GetType(Requete_FTP).Assembly)
        Using frm As New Requete_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "SendCommand", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
