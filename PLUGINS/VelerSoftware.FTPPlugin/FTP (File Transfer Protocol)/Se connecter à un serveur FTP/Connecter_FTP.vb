<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Connecter_FTP_Designer))> _
Public Class Connecter_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Connecter_FTP", GetType(Connecter_FTP).Assembly)
        Using frm As New Connecter_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "Connect", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param2, False, False)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param3, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param4, True)))
                If Param5 = Nothing Then
                    Return MsgBoxStatement
                Else
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Param5), MsgBoxStatement)
                End If
            Else
                Return Nothing
            End If
    ...
    Public Overrides Function ResolveError(ByVal ErrorToResole As SZVB.Projet.Erreur, ByVal e As System.EventArgs) As Boolean
        ...
        If ErrorToResole.Type = SZVB.Projet.Erreur.ErrorType.Building Then
            ...
            ElseIf ErrorToResole.ErrorNumber = "BC30451" Then ' La variable n'existe plus 
                ...
                Next
                If Not oki Then Tools.GetCurrentProjectVariableList.Add(New VelerSoftware.SZVB.Projet.Variable(Me.Param5, False, Nothing, Nothing))
