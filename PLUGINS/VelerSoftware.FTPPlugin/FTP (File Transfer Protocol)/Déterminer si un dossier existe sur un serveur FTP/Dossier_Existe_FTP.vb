<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Dossier_Existe_FTP_Designer))> _
Public Class Dossier_Existe_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Dossier_Existe_FTP", GetType(Dossier_Existe_FTP).Assembly)
        Using frm As New Dossier_Existe_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "DirectoryExists", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
