Public Class Creer_Dossier_FTP_Form
    ...
    Private Sub FonctionForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        With Me
            ...
            .Hote_ActionTextBox1.Text = "/path/new directory"
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "CreateDirectory", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Hote_ActionTextBox1.Text, True)))
