<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Creer_Dossier_FTP_Designer))> _
Public Class Creer_Dossier_FTP
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.creer_dossier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Creer_Dossier_FTP", GetType(Creer_Dossier_FTP).Assembly)
        Using frm As New Creer_Dossier_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "CreateDirectory", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
