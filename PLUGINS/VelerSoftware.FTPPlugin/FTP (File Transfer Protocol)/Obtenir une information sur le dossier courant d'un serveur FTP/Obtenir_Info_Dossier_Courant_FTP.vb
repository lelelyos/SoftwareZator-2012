<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Obtenir_Info_Dossier_Courant_FTP_Designer))> _
Public Class Obtenir_Info_Dossier_Courant_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Obtenir_Info_Dossier_Courant_FTP", GetType(Obtenir_Info_Dossier_Courant_FTP).Assembly)
        Using frm As New Obtenir_Info_Dossier_Courant_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "GetCurrentDirectoryInfo")
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Param1), MsgBoxStatement)
            Else
                Return Nothing
            End If
        End If
