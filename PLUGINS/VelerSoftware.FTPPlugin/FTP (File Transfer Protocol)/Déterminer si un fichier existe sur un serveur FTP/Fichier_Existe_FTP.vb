<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Fichier_Existe_FTP_Designer))> _
Public Class Fichier_Existe_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Fichier_Existe_FTP", GetType(Fichier_Existe_FTP).Assembly)
        Using frm As New Fichier_Existe_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "FileExists", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
