<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Supprimer_Dossier_FTP_Designer))> _
Public Class Supprimer_Dossier_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Supprimer_Dossier_FTP", GetType(Supprimer_Dossier_FTP).Assembly)
        Using frm As New Supprimer_Dossier_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "RemoveDirectory", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
