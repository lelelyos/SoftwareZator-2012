<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Envoyer_Fichier_FTP_Designer))> _
Public Class Envoyer_Fichier_FTP
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.upload
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Envoyer_Fichier_FTP", GetType(Envoyer_Fichier_FTP).Assembly)
        Using frm As New Envoyer_Fichier_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "UploadFile", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param2, True)))
