<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Liste_Fichier_FTP_Designer))> _
Public Class Liste_Fichier_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Liste_Fichier_FTP", GetType(Liste_Fichier_FTP).Assembly)
        Using frm As New Liste_Fichier_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "GetFiles", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
