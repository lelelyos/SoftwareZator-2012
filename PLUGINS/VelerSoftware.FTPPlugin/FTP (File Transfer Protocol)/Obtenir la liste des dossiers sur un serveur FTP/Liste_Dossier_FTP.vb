<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Liste_Dossier_FTP_Designer))> _
Public Class Liste_Dossier_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Liste_Dossier_FTP", GetType(Liste_Dossier_FTP).Assembly)
        Using frm As New Liste_Dossier_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "GetDirectories", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
