<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Definir_Dossier_Courant_FTP_Designer))> _
Public Class Definir_Dossier_Courant_FTP
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.dossier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Definir_Dossier_Courant_FTP", GetType(Definir_Dossier_Courant_FTP).Assembly)
        Using frm As New Definir_Dossier_Courant_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "SetCurrentDirectory", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
                If Param2 = Nothing Then
                    Return MsgBoxStatement
                Else
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Param2), MsgBoxStatement)
                End If
            Else
                Return Nothing
            End If
