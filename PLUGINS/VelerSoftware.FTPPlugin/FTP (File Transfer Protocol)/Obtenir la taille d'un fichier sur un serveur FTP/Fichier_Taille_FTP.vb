<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Fichier_Taille_FTP_Designer))> _
Public Class Fichier_Taille_FTP
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.fichier
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Fichier_Taille_FTP", GetType(Fichier_Taille_FTP).Assembly)
        Using frm As New Fichier_Taille_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "GetFileSize", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
