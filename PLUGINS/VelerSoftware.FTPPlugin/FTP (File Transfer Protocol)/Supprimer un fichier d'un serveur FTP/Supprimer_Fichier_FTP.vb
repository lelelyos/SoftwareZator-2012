<System.ComponentModel.Designer(GetType(VelerSoftware.FTPPlugin.Supprimer_Fichier_FTP_Designer))> _
Public Class Supprimer_Fichier_FTP
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.FTPPlugin.Supprimer_Fichier_FTP", GetType(Supprimer_Fichier_FTP).Assembly)
        Using frm As New Supprimer_Fichier_FTP_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_FTPPlugin"), "RemoveFile", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param1, True)))
