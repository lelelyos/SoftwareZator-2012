<System.ComponentModel.Designer(GetType(VelerSoftware.AccessPlugin.Obtenir_Cellule_Table_Access_Designer))> _
Public Class Obtenir_Cellule_Table_Access
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Obtenir_Cellule_Table_Access", GetType(Obtenir_Cellule_Table_Access).Assembly)
        Using frm As New Obtenir_Cellule_Table_Access_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.GetSingleValueOfRow_Access(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param4, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ")"))
            Else
                Return Nothing
            End If
        End If
