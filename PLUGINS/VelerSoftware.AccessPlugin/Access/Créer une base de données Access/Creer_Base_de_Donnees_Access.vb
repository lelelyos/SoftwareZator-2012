<System.ComponentModel.Designer(GetType(VelerSoftware.AccessPlugin.Creer_Base_de_Donnees_Access_Designer))> _
Public Class Creer_Base_de_Donnees_Access
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.create_database
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Creer_Base_de_Donnees_Access", GetType(Creer_Base_de_Donnees_Access).Assembly)
        Using frm As New Creer_Base_de_Donnees_Access_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.CreateNewDataBase_Access(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, True, False) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.CreateNewDataBase_Access(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, True, False) & ")")
                End If
            Else
                Return Nothing
            End If
