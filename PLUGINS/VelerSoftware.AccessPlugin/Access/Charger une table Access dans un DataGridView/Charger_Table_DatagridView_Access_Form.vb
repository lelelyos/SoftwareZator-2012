Public Class Charger_Table_DatagridView_Access_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Me.Boutons_ComboBox.Text.StartsWith("Me.") Then
            OperationStatement = New CodeDom.CodeAssignStatement(New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Boutons_ComboBox.Text.Substring(3).Split(" ")(0) & ".DataSource"), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.GetDataTable_Access(" & Tools.TransformKeyVariables(ActionTextBox1.Text, True, False) & ")"))
        Else
            OperationStatement = New CodeDom.CodeAssignStatement(New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeVariableReferenceExpression("Variables." & Me.Boutons_ComboBox.Text.Split("(")(0).Trim(" ")), "DataSource"), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.GetDataTable_Access(" & Tools.TransformKeyVariables(ActionTextBox1.Text, True, False) & ")"))
        End If
