Public Class Supprimer_Ligne_Table_Access_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Not Me.Boutons_ComboBox.Text = "" Then
            Dim OperationStatement As New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Boutons_ComboBox.Text), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.DeleteRowTable_Access(" & Tools.TransformKeyVariables(Me.ActionTextBox1.Text, True, False) & ", " & Tools.TransformKeyVariables(Me.ActionTextBox2.Text, False, False) & ")"))
        ...
        Else
            CodeDom.Compiler.CodeDomProvider.CreateProvider("VB").GenerateCodeFromStatement(New CodeDom.CodeSnippetStatement("VelerSoftware_AccessPlugin.DeleteRowTable_Access(" & Tools.TransformKeyVariables(Me.ActionTextBox1.Text, True, False) & ", " & Tools.TransformKeyVariables(Me.ActionTextBox2.Text, False, False) & ")"), sourceWriter, New CodeDom.Compiler.CodeGeneratorOptions())
        End If
        ...
        If (Not sender Is Nothing) AndAlso (sender.Namespaces.Count > 0) Then
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeAssignStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeAssignStatement).Right Is CodeDom.CodeMethodInvokeExpression Then
                    ...
                    If metho.Method.MethodName = "DeleteRowTable_Access" Then
                ...
                ElseIf TypeOf sta Is CodeDom.CodeExpressionStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeExpressionStatement).Expression Is CodeDom.CodeMethodInvokeExpression Then
                    ...
                    If metho2.Method.MethodName = "DeleteRowTable_Access" Then
