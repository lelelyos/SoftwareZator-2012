<System.ComponentModel.Designer(GetType(VelerSoftware.AccessPlugin.Ajouter_Colonne_Access_Designer))> _
Public Class Ajouter_Colonne_Access
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Ajouter_Colonne_Access", GetType(Ajouter_Colonne_Access).Assembly)
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Ajouter_Colonne_Access", GetType(Ajouter_Colonne_Access).Assembly)
        Using frm As New Ajouter_Colonne_Access_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.AddColumnTable_Access(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, True, False) & ", " & ChrW(34) & Me.Param4 & ChrW(34) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.AddColumnTable_Access(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, True, False) & ", " & ChrW(34) & Me.Param4 & ChrW(34) & ")")
                End If
            Else
                Return Nothing
            End If
