<System.ComponentModel.Designer(GetType(VelerSoftware.AccessPlugin.Se_deconnecter_serveur_Access_Designer))> _
Public Class Se_deconnecter_serveur_Access
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Se_deconnecter_serveur_Access", GetType(Se_deconnecter_serveur_Access).Assembly)
        Using frm As New Se_deconnecter_serveur_Access_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.Disconnect_Access()"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.Disconnect_Access()")
                End If
            Else
                Return Nothing
            End If
