Public Class Creer_Table_Access_Form
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        If Not Me.Boutons_ComboBox.Text = "" Then
            Dim OperationStatement As New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Boutons_ComboBox.Text), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.CreateNewTable_Access(" & Tools.TransformKeyVariables(Me.ActionTextBox1.Text, True, False) & ", New System.Collections.Generic.List(Of String)({" & columns_param & "}), New System.Collections.Generic.List(Of String)({" & types_param & "}))"))
        ...
        Else
            CodeDom.Compiler.CodeDomProvider.CreateProvider("VB").GenerateCodeFromStatement(New CodeDom.CodeSnippetStatement("VelerSoftware_AccessPlugin.CreateNewTable_Access(" & Tools.TransformKeyVariables(Me.ActionTextBox1.Text, True, False) & ", New System.Collections.Generic.List(Of String)({" & columns_param & "}), New System.Collections.Generic.List(Of String)({" & types_param & "}))"), sourceWriter, New CodeDom.Compiler.CodeGeneratorOptions())
        End If
