<System.ComponentModel.Designer(GetType(VelerSoftware.AccessPlugin.Creer_Table_Access_Designer))> _
Public Class Creer_Table_Access
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Creer_Table_Access", GetType(Creer_Table_Access).Assembly)
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Creer_Table_Access", GetType(Creer_Table_Access).Assembly)
        Using frm As New Creer_Table_Access_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                ...
                If Not Me.Param2 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.CreateNewTable_Access(" & Tools.TransformKeyVariables(Me.Param1, True, False) & ", New System.Collections.Generic.List(Of String)({" & columns_param & "}), New System.Collections.Generic.List(Of String)({" & types_param & "}))"))
                Else
                    Return New CodeDom.CodeSnippetStatement("VelerSoftware_AccessPlugin.CreateNewTable_Access(" & Tools.TransformKeyVariables(Me.Param1, True, False) & ", New System.Collections.Generic.List(Of String)({" & columns_param & "}), New System.Collections.Generic.List(Of String)({" & types_param & "}))")
                End If
            Else
                Return Nothing
            End If
