<System.ComponentModel.Designer(GetType(VelerSoftware.AccessPlugin.Statut_Access_Designer))> _
Public Class Statut_Access
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Statut_Access", GetType(Statut_Access).Assembly)
        Using frm As New Statut_Access_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.GetConnectStatus_Access()"))
            Else
                Return Nothing
            End If
        End If
