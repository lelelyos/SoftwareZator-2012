<System.ComponentModel.Designer(GetType(VelerSoftware.AccessPlugin.Requete_Access_Designer))> _
Public Class Requete_Access
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.AccessPlugin.Requete_Access", GetType(Requete_Access).Assembly)
        Using frm As New Requete_Access_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.ExecuteRequest_Access(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_AccessPlugin.ExecuteRequest_Access(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")")
                End If
            Else
                Return Nothing
            End If
