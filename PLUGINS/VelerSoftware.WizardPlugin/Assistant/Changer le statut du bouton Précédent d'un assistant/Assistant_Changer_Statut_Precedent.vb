<System.ComponentModel.Designer(GetType(VelerSoftware.WizardPlugin.Assistant_Changer_Statut_Precedent_Designer))> _
Public Class Assistant_Changer_Statut_Precedent
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.assistant_changer
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.WizardPlugin.Assistant_Changer_Statut_Precedent", GetType(Assistant_Changer_Statut_Precedent).Assembly)
        Using frm As New Assistant_Changer_Statut_Precedent_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1 = "Me" Then
                        Return New CodeDom.CodeSnippetExpression(Me.Param1 & "." & Me.Param2 & "BackButton()")
                    Else
                        Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & "." & Me.Param2 & "BackButton()")
                    End If
                Else
                    Return Nothing
                End If
