<System.ComponentModel.Designer(GetType(VelerSoftware.WizardPlugin.Assistant_Changer_Statut_Annuler_Designer))> _
Public Class Assistant_Changer_Statut_Annuler
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.WizardPlugin.Assistant_Changer_Statut_Annuler", GetType(Assistant_Changer_Statut_Annuler).Assembly)
        Using frm As New Assistant_Changer_Statut_Annuler_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1 = "Me" Then
                        Return New CodeDom.CodeSnippetExpression(Me.Param1 & "." & Me.Param2 & "CancelButton()")
                    Else
                        Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & "." & Me.Param2 & "CancelButton()")
                    End If
                Else
                    Return Nothing
                End If
