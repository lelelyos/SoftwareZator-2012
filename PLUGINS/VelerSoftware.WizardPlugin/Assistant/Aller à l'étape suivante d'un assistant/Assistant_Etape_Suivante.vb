<System.ComponentModel.Designer(GetType(VelerSoftware.WizardPlugin.Assistant_Etape_Suivante_Designer))> _
Public Class Assistant_Etape_Suivante
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.Assistant_Etape_Suivante
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.WizardPlugin.Assistant_Etape_Suivante", GetType(Assistant_Etape_Suivante).Assembly)
        Using frm As New Assistant_Etape_Suivante_Form
            frm.Tools = Me.Tools
            ...
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    If Me.Param1 = "Me" Then
                        Return New CodeDom.CodeSnippetExpression(Me.Param1 & ".GoToNextStep()")
                    Else
                        Return New CodeDom.CodeSnippetExpression("Variables." & Me.Param1 & ".GoToNextStep()")
                    End If
                Else
                    Return Nothing
                End If
