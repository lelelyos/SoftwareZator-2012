<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Changer_Base_de_Donnees_MySQL_Designer))> _
Public Class Changer_Base_de_Donnees_MySQL
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.change_database
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Changer_Base_de_Donnees_MySQL", GetType(Changer_Base_de_Donnees_MySQL).Assembly)
        Using frm As New Changer_Base_de_Donnees_MySQL_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.ChangeDataBase_MySQL(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.ChangeDataBase_MySQL(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")")
                End If
            Else
                Return Nothing
            End If
