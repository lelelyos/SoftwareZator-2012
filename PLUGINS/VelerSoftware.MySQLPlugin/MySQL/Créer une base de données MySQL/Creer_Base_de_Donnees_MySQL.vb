<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Creer_Base_de_Donnees_MySQL_Designer))> _
Public Class Creer_Base_de_Donnees_MySQL
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Creer_Base_de_Donnees_MySQL", GetType(Creer_Base_de_Donnees_MySQL).Assembly)
        Using frm As New Creer_Base_de_Donnees_MySQL_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.CreateNewDataBase_MySQL(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.CreateNewDataBase_MySQL(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")")
                End If
            Else
                Return Nothing
            End If
