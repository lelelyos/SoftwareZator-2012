<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Creer_Table_MySQL_Designer))> _
Public Class Creer_Table_MySQL
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Creer_Table_MySQL", GetType(Creer_Table_MySQL).Assembly)
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Creer_Table_MySQL", GetType(Creer_Table_MySQL).Assembly)
        Using frm As New Creer_Table_MySQL_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                ...
                If Not Me.Param2 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.CreateNewTable_MySQL(" & Tools.TransformKeyVariables(Me.Param1, True, False) & ", New System.Collections.Generic.List(Of String)({" & columns_param & "}), New System.Collections.Generic.List(Of String)({" & types_param & "}))"))
                Else
                    Return New CodeDom.CodeSnippetStatement("VelerSoftware_MySQLPlugin.CreateNewTable_MySQL(" & Tools.TransformKeyVariables(Me.Param1, True, False) & ", New System.Collections.Generic.List(Of String)({" & columns_param & "}), New System.Collections.Generic.List(Of String)({" & types_param & "}))")
                End If
            Else
                Return Nothing
            End If
