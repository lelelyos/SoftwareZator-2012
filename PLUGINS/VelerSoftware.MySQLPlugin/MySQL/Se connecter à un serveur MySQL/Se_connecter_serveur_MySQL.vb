<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Se_connecter_serveur_MySQL_Designer))> _
Public Class Se_connecter_serveur_MySQL
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Se_connecter_serveur_MySQL", GetType(Se_connecter_serveur_MySQL).Assembly)
        Using frm As New Se_connecter_serveur_MySQL_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_MySQLPlugin"), "Connect_MySQL", New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param2, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param3, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param4, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param5, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Param8, True)), New CodeDom.CodePrimitiveExpression(CBool(Param6)))
                If Me.Param7 = Nothing Then
                    Return MsgBoxStatement
                Else
                    Dim OperationStatement As New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Param7), MsgBoxStatement)
