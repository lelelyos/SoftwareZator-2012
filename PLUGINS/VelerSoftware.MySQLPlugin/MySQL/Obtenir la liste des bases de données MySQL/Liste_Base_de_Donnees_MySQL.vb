<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Liste_Base_de_Donnees_MySQL_Designer))> _
Public Class Liste_Base_de_Donnees_MySQL
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Liste_Base_de_Donnees_MySQL", GetType(Liste_Base_de_Donnees_MySQL).Assembly)
        Using frm As New Liste_Base_de_Donnees_MySQL_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.GetDatabases_MySQL()"))
            Else
                Return Nothing
            End If
        End If
