<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Se_deconnecter_serveur_MySQL_Designer))> _
Public Class Se_deconnecter_serveur_MySQL
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Se_deconnecter_serveur_MySQL", GetType(Se_deconnecter_serveur_MySQL).Assembly)
        Using frm As New Se_deconnecter_serveur_MySQL_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.Disconnect_MySQL()"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.Disconnect_MySQL()")
                End If
            Else
                Return Nothing
            End If
