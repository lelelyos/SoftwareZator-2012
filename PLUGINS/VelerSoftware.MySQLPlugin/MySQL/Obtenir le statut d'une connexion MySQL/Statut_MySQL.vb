<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Statut_MySQL_Designer))> _
Public Class Statut_MySQL
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.connexion_status
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Statut_MySQL", GetType(Statut_MySQL).Assembly)
        Using frm As New Statut_MySQL_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_MySQLPlugin.GetConnectStatus_MySQL()"))
            Else
                Return Nothing
            End If
        End If
