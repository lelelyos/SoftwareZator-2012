<System.ComponentModel.Designer(GetType(VelerSoftware.MySQLPlugin.Enregistrer_Table_DatagridView_MySQL_Designer))> _
Public Class Enregistrer_Table_DatagridView_MySQL
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Enregistrer_Table_DatagridView_MySQL", GetType(Enregistrer_Table_DatagridView_MySQL).Assembly)

        With Me
            .DisplayName = RM.GetString("DisplayName")
            .Description = RM.GetString("Description")
            .Category = RM.GetString("Category")
            .ToolBoxImage = My.Resources.save_table_datagridview
            ...
            .ClassCode = "VelerSoftware.MySQLPlugin.vb"
            .References.Add("mysql.data.dll")
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.MySQLPlugin.Enregistrer_Table_DatagridView_MySQL", GetType(Enregistrer_Table_DatagridView_MySQL).Assembly)
        Using frm As New Enregistrer_Table_DatagridView_MySQL_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_MySQLPlugin"), "UpdateDataTable_MySQL", New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Param1.Substring(3).Split(" ")(0) & ".DataSource"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True, False)))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_MySQLPlugin"), "UpdateDataTable_MySQL", New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeVariableReferenceExpression("Variables." & Me.Param1.Split("(")(0).Trim(" ")), "DataSource"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True, False)))
                End If
            Else
                Return Nothing
            End If
    ...
    Public Overrides Function ResolveError(ByVal ErrorToResole As SZVB.Projet.Erreur, ByVal e As System.EventArgs) As Boolean
        ...
        If ErrorToResole.Type = SZVB.Projet.Erreur.ErrorType.Building Then
            ...
            ElseIf ErrorToResole.ErrorNumber = "BC30456" Then ' Le Timer n'existe plus ou a été renommé
