<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Ajouter_Colonne_SQL_Server_Designer))> _
Public Class Ajouter_Colonne_SQL_Server
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Ajouter_Colonne_SQL_Server", GetType(Ajouter_Colonne_SQL_Server).Assembly)
        Using frm As New Ajouter_Colonne_SQL_Server_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.AddColumnTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, True, False) & ", " & ChrW(34) & Me.Param4 & ChrW(34) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.AddColumnTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, True, False) & ", " & ChrW(34) & Me.Param4 & ChrW(34) & ")")
                End If
            Else
                Return Nothing
            End If
