<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Ajouter_Ligne_Table_SQL_Server_Designer))> _
Public Class Ajouter_Ligne_Table_SQL_Server
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Ajouter_Ligne_Table_SQL_Server", GetType(Ajouter_Ligne_Table_SQL_Server).Assembly)
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Ajouter_Ligne_Table_SQL_Server", GetType(Ajouter_Ligne_Table_SQL_Server).Assembly)
        Using frm As New Ajouter_Ligne_Table_SQL_Server_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                ...
                If Not Me.Param2 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param2), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.AddRowTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param1, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ", New System.Collections.Generic.List(Of Object)({" & columns_param & "}))"))
                Else
                    Return New CodeDom.CodeSnippetStatement("VelerSoftware_SQLServerPlugin.AddRowTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param1, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ", New System.Collections.Generic.List(Of Object)({" & columns_param & "}))")
                End If
            Else
                Return Nothing
            End If
