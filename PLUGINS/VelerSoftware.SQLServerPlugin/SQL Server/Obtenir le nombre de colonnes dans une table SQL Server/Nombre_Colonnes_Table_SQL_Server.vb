<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Nombre_Colonnes_Table_SQL_Server_Designer))> _
Public Class Nombre_Colonnes_Table_SQL_Server
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Nombre_Colonnes_Table_SQL_Server", GetType(Nombre_Colonnes_Table_SQL_Server).Assembly)
        Using frm As New Nombre_Colonnes_Table_SQL_Server_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.GetColumnsCountTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")"))
            Else
                Return Nothing
            End If
        End If
