<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Obtenir_Cellule_Table_SQL_Server_Designer))> _
Public Class Obtenir_Cellule_Table_SQL_Server
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.get_table_cell
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Obtenir_Cellule_Table_SQL_Server", GetType(Obtenir_Cellule_Table_SQL_Server).Assembly)
        Using frm As New Obtenir_Cellule_Table_SQL_Server_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.GetSingleValueOfRow_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param4, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ")"))
            Else
                Return Nothing
            End If
        End If
