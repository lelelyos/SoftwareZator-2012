<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Enregistrer_Table_DatagridView_SQL_Server_Designer))> _
Public Class Enregistrer_Table_DatagridView_SQL_Server
    Inherits VelerSoftware.Plugins3.Action

    Public Sub New()
        ' Initialisation de la langue et des ressources
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Enregistrer_Table_DatagridView_SQL_Server", GetType(Enregistrer_Table_DatagridView_SQL_Server).Assembly)
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Enregistrer_Table_DatagridView_SQL_Server", GetType(Enregistrer_Table_DatagridView_SQL_Server).Assembly)
        Using frm As New Enregistrer_Table_DatagridView_SQL_Server_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Me.Param1.StartsWith("Me.") Then
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_SQLServerPlugin"), "UpdateDataTable_SQLServer", New CodeDom.CodeFieldReferenceExpression(New CodeDom.CodeThisReferenceExpression(), Me.Param1.Substring(3).Split(" ")(0) & ".DataSource"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True, False)))
                Else
                    Return New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_SQLServerPlugin"), "UpdateDataTable_SQLServer", New CodeDom.CodePropertyReferenceExpression(New CodeDom.CodeVariableReferenceExpression("Variables." & Me.Param1.Split("(")(0).Trim(" ")), "DataSource"), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Param2, True, False)))
                End If
            Else
                Return Nothing
            End If
