<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Requete_SQL_Server_Designer))> _
Public Class Requete_SQL_Server
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Requete_SQL_Server", GetType(Requete_SQL_Server).Assembly)
        Using frm As New Requete_SQL_Server_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.ExecuteRequest_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.ExecuteRequest_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ")")
                End If
            Else
                Return Nothing
            End If
