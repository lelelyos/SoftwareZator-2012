<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Liste_Base_de_Donnees_SQL_Server_Designer))> _
Public Class Liste_Base_de_Donnees_SQL_Server
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.get_databases
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Liste_Base_de_Donnees_SQL_Server", GetType(Liste_Base_de_Donnees_SQL_Server).Assembly)
        Using frm As New Liste_Base_de_Donnees_SQL_Server_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.GetDatabases_SQLServer()"))
            Else
                Return Nothing
            End If
        End If
