<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Se_deconnecter_serveur_SQL_Server_Designer))> _
Public Class Se_deconnecter_serveur_SQL_Server
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Se_deconnecter_serveur_SQL_Server", GetType(Se_deconnecter_serveur_SQL_Server).Assembly)
        Using frm As New Se_deconnecter_serveur_SQL_Server_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.Disconnect_SQLServer()"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.Disconnect_SQLServer()")
                End If
            Else
                Return Nothing
            End If
