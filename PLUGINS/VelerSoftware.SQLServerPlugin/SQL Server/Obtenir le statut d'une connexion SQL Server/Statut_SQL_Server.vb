<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Statut_SQL_Server_Designer))> _
Public Class Statut_SQL_Server
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Statut_SQL_Server", GetType(Statut_SQL_Server).Assembly)
        Using frm As New Statut_SQL_Server_Form
            frm.Tools = Me.Tools
    ...
    Public Overrides Function GetVBCode(ByVal FromFunction As Boolean) As System.CodeDom.CodeObject
        ...
        Else
            If FromFunction Then
                Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.GetConnectStatus_SQLServer()"))
            Else
                Return Nothing
            End If
        End If
