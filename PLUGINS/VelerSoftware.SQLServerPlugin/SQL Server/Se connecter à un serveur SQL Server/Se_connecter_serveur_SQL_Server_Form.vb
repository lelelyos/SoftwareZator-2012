...
Public Class Se_connecter_serveur_SQL_Server_Form
        ...
        With Me
            ...
            If Not .Param1 = Nothing Then
                If CBool(.Param1) Then
                    ...
                    .Hote_ActionTextBox1.Text = "%(ENVIRONMENT=COMPUTERNAME)%\SQLEXPRESS"
        ...
        If Me.Locale_RadioButton1.Checked Then
            ...
            If notinstalled Then
                ...
                With vd
                    ...
                    .Content = String.Format(System.Globalization.CultureInfo.InvariantCulture, RM.GetString("Content1"))
                ...
                If VelerSoftware.SZVB.Windows.Core.RunningOnXP Then
                    If VelerSoftware.Plugins3.CurrentCulture.Name = "fr" Then
                ...
                End If
            Else
                Me.Hote_ActionTextBox1.Text = "%(ENVIRONMENT=COMPUTERNAME)%\SQLEXPRESS"
    ...
    Private Sub FonctionForm_OnRefreshCodeButtonClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnRefreshCodeButtonClick
        ...
        Dim MsgBoxStatement As New CodeDom.CodeMethodInvokeExpression(New CodeDom.CodeTypeReferenceExpression("VelerSoftware_SQLServerPlugin"), "Connect_SQLServer", New CodeDom.CodePrimitiveExpression(Me.Locale_RadioButton1.Checked), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Hote_ActionTextBox1.Text, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Port_ActionTextBox2.Text, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Utilisateur_ActionTextBox3.Text, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.Mot_de_passe_ActionTextBox4.Text, True)), New CodeDom.CodeSnippetExpression(Tools.TransformKeyVariables(Me.ActionTextBox1.Text, True)), New CodeDom.CodePrimitiveExpression(Me.CheckBox1.Checked.ToString.Replace("True", "yes").Replace("False", "no")))
        ...
        If (Not sender Is Nothing) AndAlso (sender.Namespaces.Count > 0) Then
            ...
            For Each sta As CodeDom.CodeStatement In DirectCast(sender.Namespaces(0).Types(0).Members(0), CodeDom.CodeMemberMethod).Statements
                ...
                If TypeOf sta Is CodeDom.CodeExpressionStatement AndAlso TypeOf DirectCast(sta, CodeDom.CodeExpressionStatement).Expression Is CodeDom.CodeMethodInvokeExpression Then
                    ...
                    If metho.Method.MethodName = "Connect_SQLServer" Then
                        If TypeOf metho.Parameters(0) Is CodeDom.CodePrimitiveExpression Then
                            If DirectCast(metho.Parameters(0), CodeDom.CodePrimitiveExpression).Value.ToString = "True" Then
                                Locale_RadioButton1.Checked = True
                            Else
                                Distance_RadioButton2.Checked = True
                            End If
                        ...
                        If TypeOf metho.Parameters(1) Is CodeDom.CodePrimitiveExpression Then
                            Me.Hote_ActionTextBox1.Text = DirectCast(metho.Parameters(1), CodeDom.CodePrimitiveExpression).Value
                        End If
                        If TypeOf metho.Parameters(2) Is CodeDom.CodePrimitiveExpression Then
                            Me.Port_ActionTextBox2.Text = DirectCast(metho.Parameters(2), CodeDom.CodePrimitiveExpression).Value
                        End If
                        If TypeOf metho.Parameters(3) Is CodeDom.CodePrimitiveExpression Then
                            Me.Utilisateur_ActionTextBox3.Text = DirectCast(metho.Parameters(3), CodeDom.CodePrimitiveExpression).Value
                        End If
                        If TypeOf metho.Parameters(4) Is CodeDom.CodePrimitiveExpression Then
                            Me.Mot_de_passe_ActionTextBox4.Text = DirectCast(metho.Parameters(4), CodeDom.CodePrimitiveExpression).Value
                        End If
                        ...
                        End If
                        If TypeOf metho.Parameters(6) Is CodeDom.CodePrimitiveExpression Then
                            If DirectCast(metho.Parameters(6), CodeDom.CodePrimitiveExpression).Value.ToString = "yes" Then
