<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Supprimer_Ligne_Table_SQL_Server_Designer))> _
Public Class Supprimer_Ligne_Table_SQL_Server
    ...
    Public Sub New()
        ...
        With Me
            ...
            .ToolBoxImage = My.Resources.delete_table_row
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Supprimer_Ligne_Table_SQL_Server", GetType(Supprimer_Ligne_Table_SQL_Server).Assembly)
        Using frm As New Supprimer_Ligne_Table_SQL_Server_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.DeleteRowTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ")"))
                Else
                    Return New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.DeleteRowTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ")")
                End If
            Else
                Return Nothing
            End If
