<System.ComponentModel.Designer(GetType(VelerSoftware.SQLServerPlugin.Modifier_Ligne_Table_SQL_Server_Designer))> _
Public Class Modifier_Ligne_Table_SQL_Server
    ...
    Public Overrides Function Main() As Boolean
        ...
        System.Threading.Thread.CurrentThread.CurrentUICulture = VelerSoftware.Plugins3.CurrentCulture
        RM = New System.Resources.ResourceManager("VelerSoftware.SQLServerPlugin.Modifier_Ligne_Table_SQL_Server", GetType(Modifier_Ligne_Table_SQL_Server).Assembly)
        Using frm As New Modifier_Ligne_Table_SQL_Server_Form
            frm.Tools = Me.Tools
        ...
        Else
            If FromFunction Then
                If Not Me.Param1 = Nothing Then
                    Return New CodeDom.CodeAssignStatement(New CodeDom.CodeVariableReferenceExpression(Me.Param1), New CodeDom.CodeSnippetExpression("VelerSoftware_SQLServerPlugin.ChangeRowTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ", " & Tools.TransformKeyVariables(Me.Param4, True, False) & ", " & Me.Param5 & ")"))
                Else
                    Return New CodeDom.CodeSnippetStatement("VelerSoftware_SQLServerPlugin.ChangeRowTable_SQLServer(" & Tools.TransformKeyVariables(Me.Param2, True, False) & ", " & Tools.TransformKeyVariables(Me.Param3, False, False) & ", " & Tools.TransformKeyVariables(Me.Param4, True, False) & ", " & Me.Param5 & ")")
                End If
            Else
                Return Nothing
            End If
